...
`;function fl(){let e={fogTime:{value:0},fogDrift:{value:new K},fogAmount:{value:cl},fogIntro:{value:0},fogColor:{value:ll}};return{uniforms:e,update(t,n,r){e.fogTime.value=n,e.fogIntro.value=Math.min(1,n/ul),e.fogDrift.value.x-=r.x*t*1.3,e.fogDrift.value.y-=r.z*t*1.3}}}var pl=15,ml=-38,hl=1.35,gl=900,_l=`#161d19`,vl=`#2c3b31`,yl=`#1c3526`,bl=4,xl=.25,Sl=`#060a07`,Cl=1,wl=.35,Tl=.3,El=.9,Dl=1.5,Ol=.5,kl=900,Al=60,jl=1,Ml=.3,Nl=.1,Pl=4,Fl=.1,Il=`#7d9486`,Ll=.15,Rl=5.058333333333334;function zl(){let e=document.createElement(`canvas`);e.width=e.height=1;let t=e.getContext(`2d`,{willReadFrequently:!0}),n=t,r=()=>{let t=document.createElement(`canvas`);return t.width=e.width,t.height=e.height,t.getContext(`2d`,{willReadFrequently:!0})},i=new ai(e);i.colorSpace=Ke,i.minFilter=i.magFilter=y,i.generateMipmaps=!1;let a=document.createElement(`canvas`);a.width=a.height=1;let o=a.getContext(`2d`,{willReadFrequently:!0}),s=new ai(a);s.minFilter=s.magFilter=y,s.generateMipmaps=!1;let c=document.createElement(`canvas`);c.width=c.height=1;let l=c.getContext(`2d`,{willReadFrequently:!0}),u=new ai(c);u.minFilter=u.magFilter=y,u.generateMipmaps=!1;let d=document.createElement(`canvas`).getContext(`2d`,{willReadFrequently:!0}),f={inkOpacity:{value:1},inkDirMap:{value:s},inkAgeMap:{value:u},inkNowStep:{value:0},inkAgeStep:{value:Rl},inkLifespan:{value:600},inkFade:{value:3}},p=613,m=0,h=e=>Math.floor(e/Rl)-m,g=e=>{if(m+=e,c.width>1){let t=l.getImageData(0,0,c.width,c.height),n=t.data;for(let t=0;t<n.length;t+=4)n[t+3]&&(n[t]=Math.max(0,n[t]-e));l.putImageData(t,0,0),u.needsUpdate=!0}for(let t of new Set([...O,...j,...ae()]))t.born=Math.max(0,t.born-e)},_=0,v=1,b=null,x=null,C=new WeakMap,w=()=>{let e=C.get(n);return e||C.set(n,e=n.createPattern(x,`repeat`)),e},T=1,E=new Set,D=new It(2,2,-1,-1),O=[],k=null,A=new Set,j=[],ee=(t,n,r,i,a=null)=>{let o=Math.max(0,Math.floor(t/128)),s=Math.max(0,Math.floor(n/128)),c=Math.min(T-1,Math.floor(r/128)),l=Math.min(Math.ceil(e.height/128)-1,Math.floor(i/128));for(let e=s;e<=l;e++)for(let t=o;t<=c;t++){let n=e*T+t;E.add(n),a?.tiles.add(n)}},M=(t,n,r,i)=>{D.x=Math.min(D.x,t/e.width),D.y=Math.min(D.y,1-i/e.height),D.z=Math.max(D.z,r/e.width),D.w=Math.max(D.w,1-n/e.height)},N=(e,t,n,r)=>{ee(e,t,n,r,k),M(e,t,n,r),k&&(k.x0=Math.min(k.x0,e),k.y0=Math.min(k.y0,t),k.x1=Math.max(k.x1,n),k.y1=Math.max(k.y1,r))},P=()=>{D.set(2,2,-1,-1);for(let e of[...O,...ae()])M(e.x0,e.y0,e.x1,e.y1)},te=()=>{let e=Math.max(2,Math.round(bl*v)),t=document.createElement(`canvas`);t.width=t.height=e;let n=t.getContext(`2d`,{willReadFrequently:!0});n.fillStyle=_l,n.fillRect(0,0,e,e),n.fillStyle=vl,n.globalAlpha=xl,n.beginPath(),n.arc(e/2,e/2,e*.24,0,Math.PI*2),n.fill(),x=t,C=new WeakMap},ne=()=>({active:!1,x:0,y:0,sx:0,sy:0,t:0,width:1,speed:0,peak:0,peakT:0,splatted:!0,dirX:1,dirY:0,streaks:[],rest:0,pts:[],tailDrawn:!0}),re=new Map,I=ne(),ie=null,L=e=>{ie=re.get(e),ie||re.set(e,ie={stroke:ne(),current:null,layer:null}),ie.layer||(ie.layer=r()),I=ie.stroke,k=ie.current,n=ie.layer},ae=()=>[...re.values()].map(e=>e.current).filter(Boolean),oe=(e,t,n,r,i,a,o,s)=>{e.beginPath(),e.moveTo(t-a*s,n-o*s),e.lineTo(t+a*s,n+o*s),e.lineTo(r+a*s,i+o*s),e.lineTo(r-a*s,i-o*s),e.closePath()},se=(e,t,n,r,i,a)=>{e.beginPath();for(let o=0;o<=32;o++){let s=o/32*Math.PI*2,c=r*i*(1+.12*Math.sin(3*s+a[0])+.07*Math.sin(5*s+a[1])+.05*Math.sin(8*s+a[2]));o?e.lineTo(t+Math.cos(s)*c,n+Math.sin(s)*c):e.moveTo(t+Math.cos(s)*c,n+Math.sin(s)*c)}e.closePath()},ce=(e,t,n,r=0,i=!0)=>{let a=Math.hypot(t,n);a<.001?(t=I.dirX,n=I.dirY):(t/=a,n/=a);let s=Math.round((t*.5+.5)*255),c=Math.round((n*.5+.5)*255);o.fillStyle=o.strokeStyle=`rgb(${s},${c},0)`,o.lineJoin=o.lineCap=`round`,o.globalCompositeOperation=`destination-over`,o.lineWidth=r+12*v,e(o),i&&o.fill(),o.stroke(),o.globalCompositeOperation=`source-over`,o.lineWidth=r+2*v,e(o),i&&o.fill(),o.stroke()},le=(e,t,n=!0)=>{let r=`rgb(${k?k.born:h(p)},0,0)`;l.fillStyle=r,l.strokeStyle=r,l.lineJoin=`round`,l.lineCap=`round`,l.globalCompositeOperation=`destination-over`,l.lineWidth=t+4+_*2,e(l),n&&l.fill(),l.stroke(),l.globalCompositeOperation=`source-over`,l.lineWidth=t+4,e(l),n&&l.fill(),l.stroke()},ue=()=>{let e=Math.floor(p/Ll),t=k.groups[k.groups.length-1];return(!t||t.bucket!==e)&&(t={bucket:e,t:p,line:[],blots:[],half:0,n:0,next:p+Fl,wobble:.9+Math.random()*.2,x0:1/0,y0:1/0,x1:-1/0,y1:-1/0},k.groups.push(t)),t},de=(e,t,n,r,i)=>{e.x0=Math.min(e.x0,t),e.y0=Math.min(e.y0,n),e.x1=Math.max(e.x1,r),e.y1=Math.max(e.y1,i)},fe=(e,t,n,r,i,a,o,s,c)=>{if(!k)return;let l=ue(),u=l.line,d=u.length;(!d||Math.abs(u[d-2]-e)+Math.abs(u[d-1]-t)>.5)&&(d&&u.push(NaN,NaN),u.push(e,t)),u.push(n,r),l.half+=(i-l.half)/++l.n,de(l,a,o,s,c)},R=(e,t,n,r,i,a,o)=>{if(!k)return;let s=ue();s.blots.push(e,t,n),de(s,r,i,a,o)},z=(e,t)=>{e.beginPath();let n=t.line,r=!1;for(let t=0;t<n.length;t+=2)Number.isNaN(n[t])?r=!1:r?e.lineTo(n[t],n[t+1]):(e.moveTo(n[t],n[t+1]),r=!0)},pe=(e,t,n)=>{e.beginPath();let r=t.blots;for(let t=0;t<r.length;t+=3)e.moveTo(r[t]+r[t+2]+n,r[t+1]),e.arc(r[t],r[t+1],r[t+2]+n,0,Math.PI*2)},me=(e,t,r,i,a)=>{let o=(ml+(Math.random()-.5)*6)*Math.PI/180,s=pl/2*v*a*(1+(Math.random()-.5)*.16),c=Math.cos(o)*s,l=Math.sin(o)*s,u=a=>oe(n,e,t,r,i,c,l,a),d=(a=n)=>{a.beginPath(),a.moveTo(e,t),a.lineTo(r,i)};n.globalCompositeOperation=`source-over`,n.fillStyle=w(),n.strokeStyle=w(),u(.72),n.fill(),n.lineWidth=1.1*v,d(),n.stroke();let f=Math.max(0,1-I.speed/500);f>0&&(n.globalAlpha=.045*f*Cl,n.fillStyle=Sl,u(.6),n.fill()),n.strokeStyle=yl,n.lineCap=`round`;for(let[a,o]of I.streaks)n.globalAlpha=o,n.lineWidth=.9*v,n.beginPath(),n.moveTo(e+c*a*.72,t+l*a*.72),n.lineTo(r+c*a*.72,i+l*a*.72),n.stroke();n.globalAlpha=1,n.globalCompositeOperation=`destination-over`,n.fillStyle=yl,n.strokeStyle=yl,n.lineJoin=`round`,n.lineWidth=2*v,u(1),n.fill(),n.stroke(),n.lineWidth=2.6*v,d(),n.stroke(),n.globalCompositeOperation=`source-over`;let p=Math.abs(c)+Math.abs(l)+10*v+_,m=Math.min(e,r)-p,h=Math.min(t,i)-p,g=Math.max(e,r)+p,y=Math.max(t,i)+p;return N(m,h,g,y),fe(e,t,r,i,s,m,h,g,y),s},he=(e,t,r,i=.25)=>{let a=[Math.random()*6.3,Math.random()*6.3,Math.random()*6.3],o=i=>se(n,e,t,r,i,a);n.globalCompositeOperation=`source-over`,n.fillStyle=w(),o(1),n.fill(),n.globalAlpha=i*Cl,n.fillStyle=Sl,o(.8),n.fill(),n.globalAlpha=1,n.globalCompositeOperation=`destination-over`,n.fillStyle=yl,o(1),n.lineWidth=2.4*v,n.strokeStyle=yl,n.stroke(),n.fill(),n.globalCompositeOperation=`source-over`,le(n=>se(n,e,t,r,1,a),2.4*v);let s=r*1.3+4*v+_;N(e-s,t-s,e+s,t+s),R(e,t,r,e-s,t-s,e+s,t+s)},ge=()=>pl*v,_e=()=>{let r=ae();for(let i of[...j,...r]){n=i.layer??t;let a=!1;for(let t of i.groups){let r=p-t.t;if(r>=Pl||(a=!0,p<t.next))continue;t.next=Math.max(t.next+Fl,p);let o=Nl*Ml*ge()*(1-Math.exp(-3*r/Pl));if(o<.3*v)continue;let s=o*t.wobble;n.globalCompositeOperation=`destination-over`,n.globalAlpha=1-.965**(Fl/.2),n.fillStyle=n.strokeStyle=Il,n.lineJoin=n.lineCap=`round`,n.lineWidth=2*(t.half+s),z(n,t),n.stroke(),t.blots.length&&(pe(n,t,s),n.fill()),n.globalAlpha=1,n.globalCompositeOperation=`source-over`;let c=`rgb(${i.born},0,0)`;l.globalCompositeOperation=`destination-over`,l.fillStyle=l.strokeStyle=c,l.lineJoin=l.lineCap=`round`,l.lineWidth=2*(t.half+s+_)+4,z(l,t),l.stroke(),t.blots.length&&(pe(l,t,s+_+2),l.fill()),l.globalCompositeOperation=`source-over`;let u=t.half+s+4*v,f=Math.max(0,Math.floor(t.x0-u)),m=Math.max(0,Math.floor(t.y0-u)),h=Math.min(e.width,Math.ceil(t.x1+u))-f,g=Math.min(e.height,Math.ceil(t.y1+u))-m;h>0&&g>0&&(d.clearRect(f,m,h,g),d.globalCompositeOperation=`source-over`,d.fillStyle=d.strokeStyle=c,d.lineJoin=d.lineCap=`round`,d.lineWidth=2*(t.half+s),z(d,t),d.stroke(),t.blots.length&&(pe(d,t,s),d.fill()),d.globalCompositeOperation=`destination-out`,d.drawImage(e,f,m,h,g,f,m,h,g),d.globalCompositeOperation=`source-over`,l.drawImage(d.canvas,f/2,m/2,h/2,g/2,f,m,h,g));let y=t.half+s+_+2,b=t.x0-y,x=t.y0-y,S=t.x1+y,C=t.y1+y;ee(b,x,S,C,i),M(b,x,S,C),i.x0=Math.min(i.x0,b),i.y0=Math.min(i.y0,x),i.x1=Math.max(i.x1,S),i.y1=Math.max(i.y1,C)}!a&&!r.includes(i)&&(i.groups=[],j.splice(j.indexOf(i),1))}},ve=(e,t,n,r,i)=>{let a=(e,t)=>Math.max(1e-4,Math.sqrt(Math.hypot(t.x-e.x,t.y-e.y))),o=a(e,t),s=o+a(t,n),c=s+a(n,r),l=o+(s-o)*i,u=(e,t,n,r)=>{let i=(l-n)/(r-n);return{x:e.x+(t.x-e.x)*i,y:e.y+(t.y-e.y)*i}},d=u(e,t,0,o),f=u(t,n,o,s),p=u(n,r,s,c);return u(u(d,f,0,s),u(f,p,o,c),o,s)},ye=(e,t,n,r)=>{let i=Math.hypot(n.x-t.x,n.y-t.y),a=Math.max(1,Math.ceil(i*1.15/(1.5*v))),o=t,s=[t],c=0;for(let i=1;i<=a;i++){let l=i/a,u=ve(e,t,n,r,l);c=Math.max(c,me(o.x,o.y,u.x,u.y,t.w+(n.w-t.w)*l)),s.push(u),o=u}be(s,c,n.x-t.x,n.y-t.y),I.sx=n.x,I.sy=n.y},be=(e,t,n,r)=>{let i=t=>{t.beginPath(),t.moveTo(e[0].x,e[0].y);for(let n=1;n<e.length;n++)t.lineTo(e[n].x,e[n].y)},a=2*t+2.6*v;ce(i,n,r,a,!1),le(i,a,!1)},xe=()=>{let e=I.pts,t=e.length;I.tailDrawn||t<2||(ye(e[t-3]??e[t-2],e[t-2],e[t-1],e[t-1]),I.tailDrawn=!0)},Se=()=>{I.splatted=!0;let e=Math.min(2,Math.max(.6,.6+(I.peak-kl)/kl))*jl,t=Math.atan2(I.dirY,I.dirX);he(I.sx+I.dirX*ge()*.2,I.sy+I.dirY*ge()*.2,ge()*.32,.3);let n=Math.round((3+Math.random()*4)*e);for(let r=0;r<n;r++){let n=t+(Math.random()-.5)*1,r=ge()*(.5+Math.random()**.7*3.2*Math.sqrt(e)),i=ge()*(.04+Math.random()**2.2*.17),a=I.sx+Math.cos(n)*r,o=I.sy+Math.sin(n)*r;if(he(a,o,i,.3),Math.random()<.4){let e=i*(2+Math.random()*3);for(let t=1;t<=3;t++)he(a-Math.cos(n)*e*(t/3),o-Math.sin(n)*e*(t/3),i*(.75-t*.17),.2)}}},Ce=n=>{let r=n%T*128,i=Math.floor(n/T)*128,a=Math.min(128,e.width-r),s=Math.min(128,e.height-i);if(a<=0||s<=0)return;let u=t.getImageData(r,i,a,s),d=r>>1,p=i>>1,m=Math.min(c.width-d,a+1>>1),h=Math.min(c.height-p,s+1>>1);if(m<=0||h<=0)return;let g=l.getImageData(d,p,m,h),_=g.data,v=f.inkNowStep.value,y=603/Rl,b=!1;for(let e=0;e<s;e++){let t=Math.min(h-1,e>>1)*m;for(let n=0;n<a;n++){let r=(e*a+n)*4;if(!u.data[r+3])continue;let i=(t+Math.min(m-1,n>>1))*4;_[i+3]&&v-_[i]>=y&&(u.data[r]=u.data[r+1]=u.data[r+2]=u.data[r+3]=0,b=!0)}}b&&t.putImageData(u,r,i);let x=o.getImageData(d,p,m,h),S=!1;for(let e=0;e<_.length;e+=4)_[e+3]&&v-_[e]>=y&&(_[e]=_[e+1]=_[e+2]=_[e+3]=0,x.data[e]=x.data[e+1]=x.data[e+2]=x.data[e+3]=0,S=!0);S&&(l.putImageData(g,d,p),o.putImageData(x,d,p)),(b||S)&&E.add(n)},we=(e,t)=>{let n=t-I.t;if(n>30&&xe(),n>45&&!I.splatted&&(I.peak*Math.exp(-n/150)>kl*.7?Se():I.splatted=!0),n<90||I.rest>=Dl)return;I.rest=Math.min(Dl,I.rest+e);let r=I.rest/Dl;he(I.sx,I.sy,ge()*El*(.35+.65*Math.sqrt(r)),.04)},Te=()=>{if(I.active){if(xe(),Math.random()<.6&&he(I.sx,I.sy,ge()*Tl*(.7+Math.random()*.6),.25),I.speed>700&&Math.random()<Ol){let e=1+Math.floor(Math.random()*3);for(let t=0;t<e;t++){let e=ge()*(1.5+Math.random()*3),t=(Math.random()-.5)*ge();he(I.sx+I.dirX*e-I.dirY*t,I.sy+I.dirY*e+I.dirX*t,ge()*(.07+Math.random()*.12),.3)}}if(I.active=!1,ie.lastUp=performance.now(),k){for(let e of k.tiles){let r=e%T*128,i=Math.floor(e/T)*128;t.drawImage(n.canvas,r,i,128,128,r,i,128,128),n.clearRect(r,i,128,128)}k.layer=null}k&&(k.expires=(k.born+m)*Rl+600+3+Rl+.5,O.push(k)),k?.groups.length&&j.push(k),k=ie.current=null}};return{texture:i,bounds:D,uniforms:f,get width(){return e.width},get height(){return e.height},resize(n,f,p,m={cx:n/2,base:Math.min(n,f)}){v=p;let h=b;if(b=m,e.width===n&&e.height===f&&h&&Math.abs(h.cx-m.cx)<.5)return;for(let n of re.values())n.layer&&(e.width>1&&t.drawImage(n.layer.canvas,0,0),n.layer=null,n.current&&(n.current.layer=null));let g=h??{cx:e.width/2,base:Math.min(e.width,e.height)},y=m.base/g.base,x=m.cx-g.cx*y,S=(f-e.height*y)/2,C=e=>{if(e.width<=1)return null;let t=document.createElement(`canvas`);return t.width=e.width,t.height=e.height,t.getContext(`2d`,{willReadFrequently:!0}).drawImage(e,0,0),t},w=C(e),D=C(a),k=C(c);e.width>1&&(_*=n/e.width),e.width=n,e.height=f,T=Math.ceil(n/128),w&&t.drawImage(w,x,S,w.width*y,w.height*y),a.width=Math.ceil(n/2),a.height=Math.ceil(f/2),D&&o.drawImage(D,x/2,S/2,D.width*y,D.height*y),c.width=a.width,c.height=a.height,k&&(l.imageSmoothingEnabled=!1,l.drawImage(k,x/2,S/2,k.width*y,k.height*y)),d.canvas.width=c.width,d.canvas.height=c.height;for(let e of[o,l,d])e.setTransform(.5,0,0,.5,0,0);for(let e of re.values())e.current&&(e.layer=r(),e.current.layer=e.layer);if(w){let e=e=>e*y+x,t=e=>e*y+S;for(let n of new Set([...O,...j,...ae()])){n.x0=e(n.x0),n.x1=e(n.x1),n.y0=t(n.y0),n.y1=t(n.y1),n.tiles=new Set,ee(n.x0,n.y0,n.x1,n.y1,n);for(let r of n.groups??[]){r.x0=e(r.x0),r.x1=e(r.x1),r.y0=t(r.y0),r.y1=t(r.y1),r.half*=y;for(let n=0;n<r.line.length;n+=2)r.line[n]=e(r.line[n]),r.line[n+1]=t(r.line[n+1]);for(let n=0;n<r.blots.length;n+=3)r.blots[n]=e(r.blots[n]),r.blots[n+1]=t(r.blots[n+1]),r.blots[n+2]*=y}}for(let{stroke:n}of re.values()){n.x=e(n.x),n.y=t(n.y),n.sx=e(n.sx),n.sy=t(n.sy);for(let r of n.pts)r.x=e(r.x),r.y=t(r.y)}}te();for(let e of[i,s,u])e.dispose(),e.needsUpdate=!0;A.clear(),E.clear()},clear(){for(let[e,t]of re)t.stroke.active&&(L(e),t.stroke.active=!1),t.current=null,t.layer=null;k=null,n=t;for(let n of[t,o,l])n.clearRect(0,0,e.width,e.height);O.length=0,j.length=0,A.clear(),E.clear(),P();for(let e of[i,s,u])e.needsUpdate=!0},setTime(e){p=e+613,h(e)>250&&g(h(e)-125),f.inkNowStep.value=e/Rl-m},setBlurReach(e){_=e*v},begin(e,t,r,i=`user`,{age:a=0}={}){L(i);let o=Array.from({length:2+Math.floor(Math.random()*2)},()=>[Math.random()*1.6-.8,.35+Math.random()*.35]);Object.assign(I,{active:!0,x:e,y:t,sx:e,sy:t,t:r,width:hl*.9,speed:0,peak:0,peakT:r,splatted:!0,streaks:o,rest:0,pts:[{x:e,y:t,w:hl*.9}],tailDrawn:!0}),k=ie.current={x0:e,y0:t,x1:e,y1:t,groups:[],tiles:new Set,layer:n,born:Math.max(0,h(p-Math.min(a,613)))},he(e,t,ge()*wl*(.8+Math.random()*.4),.2);let s=me(e,t,e+.01,t+.01,I.width);be([{x:e,y:t},{x:e+.01,y:t+.01}],s,0,0)},move(e,t,n,r=`user`){if(L(r),!I.active)return;let i=Math.max(1,n-I.t),a=Math.hypot(e-I.x,t-I.y),o=a/v/i*1e3;a>1.5*v&&(I.dirX=(e-I.x)/a,I.dirY=(t-I.y)/a),I.x=e,I.y=t,I.t=n,I.speed+=(o-I.speed)*.3,I.peak=Math.max(I.peak*Math.exp(-(n-I.peakT)/150),I.speed),I.peakT=n,a>.5*v&&(I.rest=0);let s=hl+-1.1700000000000002*(1-(1-Math.min(1,I.speed/gl))**2);I.width+=(s-I.width)*.25;let c=I.pts,l=c[c.length-1];if(Math.hypot(e-l.x,t-l.y)>=.75*v){c.push({x:e,y:t,w:I.width});let n=c.length;n>=3&&!I.tailDrawn&&ye(c[n-4]??c[n-3],c[n-3],c[n-2],c[n-1]),I.tailDrawn=!1,n>4&&c.shift()}o>120?I.splatted=!1:o<Al&&!I.splatted&&I.peak>kl&&Se()},update(e,t){(j.length||ae().length)&&_e();{let e=!1;for(let t=O.length-1;t>=0;t--)if(!(O[t].expires>p)){for(let e of O[t].tiles)A.add(e);O.splice(t,1),e=!0}e&&P();let t=4;for(let e of A)if(A.delete(e),Ce(e),--t===0)break}for(let[n,r]of re){if(!r.stroke.active&&!r.current&&r.layer&&performance.now()-(r.lastUp??0)>5e3){r.layer=null;continue}r.stroke.active&&(L(n),we(e,t))}},end(e=`user`){L(e),Te()},flush(n){if(!E.size)return;let r=(e,t,r,i,a,o,s)=>{let c=new Kr(e,a,o,F,S);n.copyTextureToTexture(c,t,null,new K(r,s-i-o)),c.dispose()},d=[...E].sort((e,t)=>e-t);E.clear();for(let n=0;n<d.length;){let f=Math.floor(d[n]/T),p=d[n]%T,m=p;for(;n+1<d.length&&d[n+1]===d[n]+1&&Math.floor(d[n+1]/T)===f;)n++,m++;n++;let h=p*128,g=f*128,_=Math.min(e.width,(m+1)*128)-h,v=Math.min(e.height,g+128)-g;if(_<=0||v<=0)continue;let y=[];for(let e of re.values()){let t=e.current?.tiles;if(e.layer&&t){for(let n=p;n<=m;n++)if(t.has(f*T+n)){y.push(e.layer);break}}}let b=t.getImageData(h,g,_,v).data;for(let e of y){let t=e.getImageData(h,g,_,v).data;for(let e=0;e<b.length;e+=4){let n=t[e+3];if(!n)continue;let r=b[e+3];if(n===255||!r){b[e]=t[e],b[e+1]=t[e+1],b[e+2]=t[e+2],b[e+3]=n;continue}let i=n/255,a=r/255*(1-i),o=1/(i+a);b[e]=(t[e]*i+b[e]*a)*o,b[e+1]=(t[e+1]*i+b[e+1]*a)*o,b[e+2]=(t[e+2]*i+b[e+2]*a)*o,b[e+3]=(i+a)*255}}r(new Uint8Array(b.buffer),i,h,g,_,v,e.height);let x=h/2,S=g/2,C=Math.min(a.width,Math.ceil((h+_)/2))-x,w=Math.min(a.height,Math.ceil((g+v)/2))-S;C>0&&w>0&&(r(new Uint8Array(o.getImageData(x,S,C,w).data.buffer),s,x,S,C,w,a.height),r(new Uint8Array(l.getImageData(x,S,C,w).data.buffer),u,x,S,C,w,c.height))}},dispose(){i.dispose(),s.dispose(),u.dispose()}}}var Bl=`
  varying vec2 vUv;
  void main() {
...
`;function Wl(e){let t=[],n=0;for(let r=0;r<=16;r++)t[r]=Math.exp(-(r*r)/(2*e*e)),n+=r?2*t[r]:t[r];let r=[0],i=[t[0]/n];for(let e=1;e<=16;e+=2){let a=t[e],o=t[e+1]??0;r.push((e*a+(e+1)*o)/(a+o)),i.push((a+o)/n)}return{offsets:r,weights:i}}function Gl(e,{blur:t,amount:n,tint:r}){let i={depthBuffer:!1,stencilBuffer:!1,minFilter:y,magFilter:y,generateMipmaps:!1},a=new Rt(1,1,i),o=new Rt(1,1,i),s=new Rt(1,1,i),c=new yr;c.setAttribute(`position`,new sr([-1,-1,0,3,-1,0,-1,3,0],3));let l=(e,t)=>new yi({vertexShader:Bl,fragmentShader:e,uniforms:t,depthTest:!1,depthWrite:!1}),u=l(Vl,{tSrc:{value:a.texture},offset:{value:new K}}),d=l(Hl,{tSrc:{value:null},dir:{value:new K},offsets:{value:[]},weights:{value:[]}}),f=l(Ul,{tScene:{value:a.texture},tBlur:{value:o.texture},amount:{value:n},tint:{value:r},tMask:{value:null},maskRemap:{value:new It(1,1,0,0)},maskOn:{value:0},maskKeep:{value:1}}),p=new Ur(c,u);p.frustumCulled=!1;let m=new Tn;m.add(p);let h=new Qi,g=(t,n)=>{p.material=t,e.setRenderTarget(n),e.render(m,h)};return{target:a,setMask(e,t,n,r){let i=f.uniforms;i.tMask.value=e,i.maskRemap.value=t,i.maskOn=n,i.maskKeep.value=r},setSize(e,n,r){let i=Math.max(1,Math.round(e*r)),c=Math.max(1,Math.round(n*r));a.setSize(i,c);let l=Math.max(1,2*r),f=Math.max(1,Math.ceil(i/l)),p=Math.max(1,Math.ceil(c/l));o.setSize(f,p),s.setSize(f,p),u.uniforms.offset.value.set(.25*l/i,.25*l/c);let{offsets:m,weights:h}=Wl(t*r/l);d.uniforms.offsets.value=m,d.uniforms.weights.value=h,this.texel=[1/f,1/p]},render(t,r){if(e.setRenderTarget(a),e.render(t,r),n<=0){f.uniforms.amount.value=0,g(f,null);return}g(u,o),d.uniforms.tSrc.value=o.texture,d.uniforms.dir.value.set(this.texel[0],0),g(d,s),d.uniforms.tSrc.value=s.texture,d.uniforms.dir.value.set(0,this.texel[1]),g(d,o),g(f,null)},async edgeColors(){let t=o.width,i=[o.height-1,0].map(n=>e.readRenderTargetPixelsAsync(o,0,n,t,1,new Uint8Array(t*4))),[a,s]=await Promise.all(i),c=e=>{let i=[0,0,0];for(let n=0;n<t;n++)for(let t=0;t<3;t++)i[t]+=e[n*4+t];return i.map(e=>(e/=t,e+(e+(255-e)*r-e)*n))};return{top:c(a),bottom:c(s)}},dispose(){for(let e of[a,o,s])e.dispose();for(let e of[u,d,f])e.dispose();c.dispose()}}}var Kl={version:2,recordings:[]},ql=.3,Jl=30,Yl=0,Xl=1;function Zl(e){return e?.recordings?e.recordings.map(e=>e.events).filter(e=>e?.length):e?.events?.length?[e.events]:[]}function Ql({element:e,container:t,down:n,move:r,up:i,offset:a=()=>0,clearPaper:o}){let s=Zl(Kl);Kl?.recordings?.map(e=>e.recordedAt);let c=null,l=null,u=-1,d=null,f=()=>{d?.remove(),d=null},p=(t,n)=>{let r=e.getBoundingClientRect(),i=Math.min(r.width,r.height);return[r.left+r.width/2+a()+t*i,r.top+r.height/2+n*i]},m=()=>{let e=Math.floor(Math.random()*s.length);return s.length>1&&e===u&&(e=(e+1+Math.floor(Math.random()*(s.length-1)))%s.length),u=e,s[e]};return{listen(e,t){return e=>{t(e)}},update(e,t){if(!s.length||!e)return;let a=performance.now();if(!c){if(l===null){if(t<ql)return;l=a}if(a<l)return;c={events:m(),i:0,start:a,held:!1}}let o=a-c.start,u=c.events;for(;c.i<u.length&&u[c.i][1]<=o;){let[e,t,a,o]=u[c.i++],[s,l]=p(a,o),d={clientX:s,clientY:l,timeStamp:c.start+t};e===Yl?(c.held=!0,n(d)):e===Xl?r(d):(c.held=!1,i(d))}c.i>=u.length&&(c.held&&i(),c=null,l=a+Jl*1e3)},dispose(){f()}}}var $l=6;function eu(){let e={active:!1,x:0,y:0,dispose(){}};if(!(typeof DeviceOrientationEvent<`u`&&window.isSecureContext&&matchMedia(`(pointer: coarse)`).matches))return e;let t=null,n=0,r=r=>{if(r.beta==null||r.gamma==null)return;let i=(screen.orientation?.angle??window.orientation??0)*Math.PI/180,a=r.gamma*Math.cos(i)-r.beta*Math.sin(i),o=r.gamma*Math.sin(i)+r.beta*Math.cos(i);if(!t)t={x:a,y:o};else{let e=1-Math.exp(-Math.min(1,(r.timeStamp-n)/1e3)/$l);t.x+=(a-t.x)*e,t.y+=(o-t.y)*e}n=r.timeStamp,e.x=a-t.x,e.y=o-t.y,e.active=!0},i=()=>addEventListener(`deviceorientation`,r),a=()=>{t=null};addEventListener(`orientationchange`,a);let o=!1,s=()=>{o||(o=!0,removeEventListener(`touchend`,s),removeEventListener(`click`,s),DeviceOrientationEvent.requestPermission().then(e=>e===`granted`&&i()).catch(()=>{}))};return typeof DeviceOrientationEvent.requestPermission==`function`?(addEventListener(`touchend`,s),addEventListener(`click`,s)):i(),e.dispose=()=>{removeEventListener(`deviceorientation`,r),removeEventListener(`orientationchange`,a),removeEventListener(`touchend`,s),removeEventListener(`click`,s)},e}var tu=`modulepreload`,nu=function(e,t){return new URL(e,t).href},ru={},iu=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=nu(t,n),t=s(t),t in ru)return;ru[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:tu,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},au={apiKey:`AIzaSyBlfFi8xlDdOL1YsYiXcCj7CNLEiOk8h60`,authDomain:`life-is-beautiful-sketches.firebaseapp.com`,databaseURL:`https://life-is-beautiful-sketches-default-rtdb.europe-west1.firebasedatabase.app`,projectId:`life-is-beautiful-sketches`,appId:`1:974924637711:web:9cb1db9b7a6453e098e57a`},ou=603e3,su=50,cu=180,lu=2e4,uu=8e3,du=0,fu=1;function pu({element:e,offset:t,pen:n,onClear:r}){let i=Math.random().toString(36).slice(2,12),a=null,o=null,s=0,c=0,l=!1,u=[],d=(n,r)=>{let i=e.getBoundingClientRect(),a=Math.min(i.width,i.height);return[(n-i.left-i.width/2-t())/a,(r-i.top-i.height/2)/a]},f=(n,r)=>{let i=e.getBoundingClientRect(),a=Math.min(i.width,i.height);return[i.left+i.width/2+t()+n*a,i.top+i.height/2+r*a]},p=()=>Date.now()+s,m=e=>e.map(([e,t,n])=>`${e.toFixed(4)},${t.toFixed(4)},${Math.round(n)}`).join(`;`),h=e=>e.split(`;`).filter(Boolean).map(e=>e.split(`,`).map(Number)),g=null,_=()=>{if(!g||!g.ref||!g.pending.length)return;let e=m(g.pending);g.pending=[];let t=`b${String(g.batches++).padStart(4,`0`)}`;a.set(a.child(g.ref,`p/${t}`),e).catch(()=>{})},v=(e,t)=>{if(!o)return;if(e===du){y();let e=a.push(a.ref(o,`strokes`));g={ref:e,start:t.timeStamp,pending:[],batches:0,timer:null},a.set(e,{t:a.serverTimestamp(),u:i}).catch(()=>{}),g.timer=setInterval(_,su)}if(!g)return;let[n,r]=d(t.clientX,t.clientY);g.pending.push([n,r,t.timeStamp-g.start])},y=()=>{g&&=(clearInterval(g.timer),_(),g.ref&&a.update(g.ref,{e:!0}).catch(()=>{}),null)},b=new Map,x=[],S=(e,t)=>{if(!e.length)return;let r=performance.now()-e[e.length-1][2];e.forEach(([e,i,a],o)=>{let[s,c]=f(e,i);o===0?n.begin(`history`,s,c,r+a,t):n.move(`history`,s,c,r+a)}),n.end(`history`)},C=e=>Object.keys(e?.p??{}).sort().map(t=>[t,e.p[t]]),w=e=>{let t=e.key,n=e.val();if(!n||n.u===i||b.has(t)||n.t<c)return;let r=p()-n.t;if(r>ou){b.set(t,!0),a.remove(e.ref).catch(()=>{});return}if(b.set(t,!0),n.e||r>lu){S(C(n).flatMap(([,e])=>h(e)),r/1e3);return}let o={penId:`live:${n.u}`,points:[],next:0,started:!1,ended:!1,done:!1,start:0,keys:new Set,lastAdd:performance.now()};x.push(o);let s=(e,t)=>{o.keys.has(e)||(o.keys.add(e),o.lastAdd=performance.now(),o.points.push(...h(t)),o.points.sort((e,t)=>e[2]-t[2]))};for(let[e,t]of C(n))s(e,t);let l=a.onChildAdded(a.child(e.ref,`p`),e=>s(e.key,e.val())),u=a.onValue(a.child(e.ref,`e`),e=>{e.val()&&(o.ended=!0)});o.stop=()=>{l(),u()}},T=()=>{let e=performance.now(),t=new Set;for(let r of x){let{penId:i}=r;if(!r.ended&&e-r.lastAdd>uu&&(r.ended=!0),!r.started&&r.ended&&!r.points.length){r.stop?.(),r.done=!0;continue}if(!r.started){if(!r.points.length||t.has(i)){t.add(i);continue}r.start=e+cu,r.started=!0}for(t.add(i);r.next<r.points.length&&r.start+r.points[r.next][2]<=e;){let[e,t,a]=r.points[r.next],[o,s]=f(e,t);r.next===0?n.begin(i,o,s,r.start+a,0):n.move(i,o,s,r.start+a),r.next++}r.ended&&r.next>=r.points.length&&(n.end(i),r.stop?.(),r.done=!0,t.delete(i))}x.some(e=>e.done)&&(x=x.filter(e=>!e.done))},E=()=>{if(!o)return;let e=a.query(a.ref(o,`strokes`),a.orderByChild(`t`),a.endAt(p()-ou-5e3),a.limitToFirst(50));a.get(e).then(e=>e.forEach(e=>void a.remove(e.ref).catch(()=>{}))).catch(()=>{})};return Promise.all([iu(()=>import(`./index.esm-Dc3UDJFU.js`),__vite__mapDeps([0,1]),import.meta.url),iu(()=>import(`./index.esm-CCxFiepB.js`),__vite__mapDeps([2,1]),import.meta.url)]).then(([e,t])=>{if(l)return;a=t,o=t.getDatabase(e.initializeApp(au,`live-sketch`)),u.push(a.onValue(a.ref(o,`.info/serverTimeOffset`),e=>{s=e.val()??0}));let n=!0;u.push(a.onValue(a.ref(o,`clearedAt`),e=>{let t=e.val()??0;if(!n&&t>c){y();for(let e of x)e.stop?.();x=[],r?.()}n=!1,c=t}));let i=a.query(a.ref(o,`strokes`),a.orderByChild(`t`),a.startAt(p()-ou));u.push(a.onChildAdded(i,w)),E();let d=setInterval(E,6e4);u.push(()=>clearInterval(d))}).catch(e=>console.warn(`Live drawing is unavailable:`,e)),{listen(e,t){return n=>{if(e===`down`)v(du,n);else if(e===`move`&&g){let e=n.getCoalescedEvents?.();for(let t of e?.length?e:[n])v(fu,t)}else(e===`up`||e===`leave`)&&y();t(n)}},update:T,dispose(){l=!0,y();for(let e of x)e.stop?.();for(let e of u)e()}}}var mu=.85;function hu(e,t,n=0){let r=mu*Math.min(e,t)/2*.97,i=Math.max(16,e*.04),a=Math.min(56,Math.max(24,e*.04)),o=Math.max(e*.575-r,i+n+a);return{pan:o+r-e/2,listRight:o-a}}function gu(e,t,n=0){let r=mu*Math.min(e,t)/2*.97,i=Math.max(16,e*.04),a=Math.min(56,Math.max(24,e*.04)),o=Math.min(e*.425+r,e-i-n-a);return{pan:o-r-e/2,textLeft:o+a}}var _u=e=>Math.round(Math.min(460,Math.max(e*.42,e-2*Math.max(16,e*.04)-120))),vu=1.5,Q=Math.random;function yu(e){let t=e>>>0;Q=()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function bu(e,t){if(typeof OffscreenCanvas<`u`)return new OffscreenCanvas(e,t);let n=document.createElement(`canvas`);return n.width=e,n.height=t,n}function xu(e,t,n,r){let i=Math.sqrt(12*r*r/3+1),a=Math.floor(i);a%2==0&&a--;let o=Math.round((12*r*r-3*a*a-12*a-9)/(-4*a-4)),s=Float32Array.from(e),c=new Float32Array(e.length),l=new Float32Array(t);for(let e=0;e<3;e++){let r=((e<o?a:a+2)-1)/2;r<1||(Su(s,c,t,n,r),Cu(c,s,t,n,r,l))}return s}function Su(e,t,n,r,i){let a=1/(2*i+1),o=n-1;for(let s=0;s<r;s++){let r=s*n,c=e[r]*(i+1);for(let t=1;t<=i;t++)c+=e[r+(t<n?t:o)];for(let s=0;s<n;s++){t[r+s]=c*a;let l=s+i+1,u=s-i;c+=e[r+(l<n?l:o)]-e[r+(u>0?u:0)]}}}function Cu(e,t,n,r,i,a){let o=1/(2*i+1),s=r-1;for(let t=0;t<n;t++)a[t]=e[t]*(i+1);for(let t=1;t<=i;t++){let i=(t<r?t:s)*n;for(let t=0;t<n;t++)a[t]+=e[i+t]}for(let c=0;c<r;c++){let l=c*n,u=(c+i+1<r?c+i+1:s)*n,d=(c-i>0?c-i:0)*n;for(let r=0;r<n;r++)t[l+r]=a[r]*o,a[r]+=e[u+r]-e[d+r]}}function wu(e,t,n,r){let i=r.logoBase*r.logoFraction,a=r.logoX-i/2,o=(n-i)/2,s=i/635,c=bu(t,n).getContext(`2d`,{willReadFrequently:!0});c.fillStyle=`#fff`,c.fillRect(0,0,t,n),c.drawImage(e,a,o,i,i);let l=c.getImageData(0,0,t,n).data,u=new Float32Array(t*n);for(let e=0;e<u.length;e++)u[e]=1-l[e*4]/255;let d=xu(u,t,n,r.roundness*s),f=xu(u,t,n,r.roundness*2.2*s),p=0;for(let e=0;e<d.length;e++)d[e]+=f[e]*.35,d[e]>p&&(p=d[e]);let m=1/(p*.8);for(let e=0;e<d.length;e++)d[e]=Math.min(1,d[e]*m);return{height:d,k:s}}function Tu(e,t){let n=bu(e,t).getContext(`2d`,{willReadFrequently:!0}),r=n.createImageData(e,t);for(let n=0;n<e*t;n++){let e=128+(Q()-.5)*70;r.data[n*4]=r.data[n*4+1]=r.data[n*4+2]=e,r.data[n*4+3]=255}n.putImageData(r,0,0),n.lineCap=`round`;let i=Math.round(e*t/160);for(let r=0;r<i;r++){let r=Q()*e,i=Q()*t,a=Q()*Math.PI*2,o=6+Q()*28,s=(Q()-.5)*o*.6;n.strokeStyle=Q()<.5?`rgba(255,255,255,0.09)`:`rgba(0,0,0,0.07)`,n.lineWidth=.6+Q()*1.2,n.beginPath(),n.moveTo(r,i),n.quadraticCurveTo(r+Math.cos(a)*o*.5-Math.sin(a)*s,i+Math.sin(a)*o*.5+Math.cos(a)*s,r+Math.cos(a)*o,i+Math.sin(a)*o),n.stroke()}let a=n.getImageData(0,0,e,t).data,o=new Float32Array(e*t);for(let e=0;e<o.length;e++)o[e]=(a[e*4]-128)/128;return xu(o,e,t,1)}function Eu(e,t,n,r,i){let a=new Float32Array(t*n);for(let e=0;e<a.length;e++)a[e]=Q()*2-1;let o=e=>{let t=0;for(let n=0;n<e.length;n++)t+=e[n]*e[n];return 1/Math.sqrt(t/e.length||1)},s=xu(a,t,n,2.2*r),c=xu(a,t,n,7*r),l=o(s)*.55*i,u=o(c)*.45*i;for(let t=0;t<e.length;t++)e[t]+=s[t]*l+c[t]*u}function Du(e,t,n,r){let i=Math.round(e*t/(n*n)*12e-5*r.fibres),a=[];for(let o=0;o<i;o++){let i=Q()*e,o=Q()*t,s=(Q()+Q()-1)*r.fibreAngleSpread*Math.PI/180,c=(Q()<.5?0:Math.PI)+s,l=(Q()-.5)*.3*r.fibreCurl,u=r.fibreLengthMin+Q()*(r.fibreLengthMax-r.fibreLengthMin),d=Math.max(2,Math.round(u/3)),f=[[i,o]];for(let e=0;e<d;e++)l+=(Q()-.5)*.12*r.fibreCurl,l*=.88,c+=l,i+=Math.cos(c)*3*n,o+=Math.sin(c)*3*n,f.push([i,o]);a.push({points:f,width:(.5+Q()**2*1.4)*n,alpha:.35+Q()*.55})}return a}function Ou(e,t,n){e.save(),e.lineCap=`round`,e.lineJoin=`round`;for(let r of t){e.strokeStyle=n(r.alpha),e.lineWidth=r.width,e.beginPath(),e.moveTo(r.points[0][0],r.points[0][1]);for(let t=1;t<r.points.length;t++)e.lineTo(r.points[t][0],r.points[t][1]);e.stroke()}e.restore()}function ku(e,t,n,r){let i=Math.round(e*t/(n*n)*15e-6*r.scratches),a=[];for(let r=0;r<i;r++){let r=(30+Q()**1.5*220)*n,i=Q()*Math.PI,o=Math.cos(i),s=Math.sin(i),c=(Q()-.5)*r*.12,l=Q()*e,u=Q()*t,d=Q()<.3?2+Math.floor(Q()*3):1;for(let e=0;e<d;e++){let t=e*(2+Q()*3)*n,i=e?.6+Q()*.4:1,d=e?(Q()-.5)*r*.2:0,f=[];for(let e=0;e<=24;e++){let n=e/24,a=(n-.5)*r*i+d,p=t+c*4*n*(1-n);f.push([l+o*a-s*p,u+s*a+o*p])}a.push({points:f,width:(.6+Q()*.8)*n,depth:.5+Q()*.5})}}return a}function Au(e,t,n){e.save(),e.lineCap=`round`;for(let r of t){let t=r.points.length-1;for(let i=0;i<t;i++){let a=Math.sqrt(Math.sin(Math.PI*(i+.5)/t));e.strokeStyle=n(r.depth*a),e.lineWidth=r.width*(.5+.5*a),e.beginPath(),e.moveTo(r.points[i][0],r.points[i][1]),e.lineTo(r.points[i+1][0],r.points[i+1][1]),e.stroke()}}e.restore()}function ju(e,t,n,r){let i=bu(e,t).getContext(`2d`,{willReadFrequently:!0});i.fillStyle=`#000`,i.fillRect(0,0,e,t),n(i);let a=i.getImageData(0,0,e,t).data,o=new Float32Array(e*t);for(let e=0;e<o.length;e++)o[e]=a[e*4]/255;return xu(o,e,t,r)}function Mu(e,t,n,r,i){let a=new Float32Array(t*n),o=new Float32Array(t*n),s=i.creaseWidth*r,c=i.creaseTilt/i.fibreStrength,l=(.8*r)**2,u=1/(2.2*r*r),d=1/(18*r*r),f=1/(140*r),p=Math.max(0,i.creaseRound)*r,m=p>0?1/(p*p):0,h=Q()<.7?(Q()<.5?0:Math.PI/2)+(Q()-.5)*8*Math.PI/180:Q()*Math.PI,g=i.logoBase,_=i.logoX+(Q()-.5)*.8*g,v=n/2+(Q()-.5)*.8*g;for(let g=0;g<i.creases;g++){let i=h+g%2*(Math.PI/2),y=Math.cos(i),b=Math.sin(i),x=g<2?0:(Q()<.5?-1:1)*(.2+Q()*.15)*Math.min(t,n),S=_-b*x,C=v+y*x,w=(Q()<.5?1:-1)*-c*s,T=w>0,E=Q()*1e3,D=1.5*r;for(let r=0;r<n;r++){let n=r-C;for(let i=0;i<t;i++){let c=i-S,h=c*y+n*b,g=-c*b+n*y+Math.sin(h*f+E)*D,_=g*g,v=r*t+i,x=m?Math.exp(-(h*h+_)*m):0,C=.5*p*x;e[v]+=w*(1-Math.exp(-Math.sqrt(_+l+C*C)/s));let O=Math.exp(-_*u)*(1-.8*x);if(O>a[v]&&(a[v]=O),T){let e=Math.exp(-_/(1/d+C*C));e>o[v]&&(o[v]=e)}}}}return{line:a,valley:o}}function Nu(e,t,n,r,i){let a=.5*t;for(let t=0;t<r;t++){let o=t*n,s=(t>0?t-1:0)*n,c=(t<r-1?t+1:r-1)*n,l=(r-1-t)*n*4;for(let t=0;t<n;t++){let r=-(e[o+(t<n-1?t+1:t)]-e[o+(t>0?t-1:0)])*a,u=(e[c+t]-e[s+t])*a,d=127.5/Math.sqrt(r*r+u*u+1);i[l+t*4]=r*d+127.5,i[l+t*4+1]=u*d+127.5}}}function Pu(e,t,n,r,i,a=e=>e){for(let o=0;o<n;o++){let s=o*t,c=(n-1-o)*t*4+i;for(let n=0;n<t;n++)r[c+n*4]=a(e[s+n])*255}}function Fu(e,t,n,r,i,a,o,s){let c=bu(t,n).getContext(`2d`,{willReadFrequently:!0}),l=c.createImageData(t,n),u=t*t+n*n,[d,f,p]=i.paperFrom,[m,h,g]=i.paperTo;for(let r=0;r<n;r++)for(let a=0;a<t;a++){let o=r*t+a,c=(a*t+r*n)/u,_=(1+e[o]*.02)*(1-(s?s[o]*i.creaseLine:0));l.data[o*4]=(d+(m-d)*c)*_,l.data[o*4+1]=(f+(h-f)*c)*_,l.data[o*4+2]=(p+(g-p)*c)*_,l.data[o*4+3]=255}c.putImageData(l,0,0),Iu(c,t,n,r,i.speckle);let[_,v,y]=i.fibreColor;Ou(c,a,e=>`rgba(${_}, ${v}, ${y}, ${e*Math.min(1,i.fibres)})`),Au(c,o,e=>`rgba(110, 110, 115, ${e*.08})`);let b=c.getImageData(0,0,t,n).data,x=new Uint8ClampedArray(t*n*4),S=t*4;for(let e=0;e<n;e++)x.set(b.subarray(e*S,(e+1)*S),(n-1-e)*S);return x}function Iu(e,t,n,r,i){let a=70*r,o=Math.ceil(t/a)+1,s=Math.ceil(n/a)+1,c=bu(o,s),l=c.getContext(`2d`,{willReadFrequently:!0}),u=l.createImageData(o,s);for(let e=0;e<o*s;e++)u.data[e*4]=120,u.data[e*4+1]=116,u.data[e*4+2]=108,u.data[e*4+3]=Q()*255;l.putImageData(u,0,0),e.save(),e.imageSmoothingEnabled=!0,e.imageSmoothingQuality=`high`,e.globalAlpha=i*.07,e.drawImage(c,0,0,o*a,s*a),e.restore();let d=()=>{let e=70+Q()*60;return`${e+10}, ${e+4}, ${e-6}`},f=Math.round(t*n/(r*r)*.0011);for(let a=0;a<f;a++){let a=Q()<.06,o=(a?1.1+Q()*.8:.35+Q()*.6)*r,s=i*(a?.18+Q()*.2:.2+Q()*.35);e.fillStyle=`rgba(${d()}, ${s})`,e.beginPath(),e.arc(Q()*t,Q()*n,o,0,Math.PI*2),e.fill()}e.lineCap=`round`;let p=Math.round(t*n/(r*r)*4e-5);for(let a=0;a<p;a++){let a=Q()*t,o=Q()*n,s=Q()*Math.PI*2,c=(4+Q()*9)*r,l=(Q()-.5)*c*.8;e.strokeStyle=`rgba(${d()}, ${i*(.15+Q()*.2)})`,e.lineWidth=(.4+Q()*.4)*r,e.beginPath(),e.moveTo(a,o),e.quadraticCurveTo(a+Math.cos(s)*c*.5-Math.sin(s)*l,o+Math.sin(s)*c*.5+Math.cos(s)*l,a+Math.cos(s)*c,o+Math.sin(s)*c),e.stroke()}}function Lu(e,t,n,r,i){let a={logoX:t/2,logoBase:Math.min(t,n),...i},o=e=>{a.seed===void 0?Q=Math.random:yu(a.seed+e*2654435769)},s=wu(e,t,n,a);o(1);let c=Tu(t,n);o(2),a.pulp>0&&Eu(c,t,n,r,a.pulp*.35),o(3);let l=a.fibres>0?Du(t,n,r,a):[];if(l.length){let e=ju(t,n,e=>Ou(e,l,e=>`rgba(255,255,255,${e})`),.8*r);for(let t=0;t<c.length;t++)c[t]+=e[t]*a.fibreRelief}let u=new Uint8ClampedArray(t*n*4);Pu(c,t,n,u,2,e=>.5+e*.2);let d=new Float32Array(t*n);o(4);let f=a.scratches>0?ku(t,n,r,a):[];if(f.length){let e=ju(t,n,e=>Au(e,f,e=>`rgba(255,255,255,${e})`),.6*r);for(let t=0;t<c.length;t++)c[t]-=e[t]*a.scratchDepth,d[t]=Math.min(1,e[t]*1.5)}let p=c.slice();o(5);let m=a.creases>0?Mu(p,t,n,r,a):null;if(m)for(let e=0;e<d.length;e++)m.valley[e]>d[e]&&(d[e]=m.valley[e]);Nu(p,a.fibreStrength,t,n,u),Pu(d,t,n,u,3),o(6);let h=Fu(c,t,n,r,a,l,f,m?.line),g=new Uint8ClampedArray(t*n*4);Nu(s.height,a.logoStrength*s.k/vu**2,t,n,g),Pu(s.height,t,n,g,2);let _=a.shadowLength*a.logoBase/2;return Pu(xu(s.height,t,n,Math.max(1,_*.6)),t,n,g,3,e=>Math.min(1,e*60)),{color:h,surface:u,logo:g}}var Ru=1.3,zu=.6,Bu=2048,Vu=4096,Hu=3.2,Uu=1.065,Wu=.45,Gu=1.6,Ku=11.5,qu=.35,Ju=1,Yu=3,Xu=5,Zu=.25,Qu=3,$u=.1,ed=.1,td=1,nd=14,rd=3.5,id=20,ad=48,od=.05,sd=1.4,cd=2.2,ld=1,ud=.45,dd=.5,fd=.7,pd=.35,md=5,hd=1,gd=1,_d=.08,vd=.45,yd=1.1,bd=1.8,xd=.06,Sd=.1,Cd=new Cn(16777215),wd=.12,Td=1.6,Ed=1,Dd=.6,Od=.5,kd=.25,Ad=20,jd=40,Md=50,Nd=.8,Pd=1,Fd=2,Id=2,Ld=100,Rd=.06,zd=.05,Bd=40,Vd=[171,188,195],Hd=`rgb(247, 251, 252)`,Ud=`rgb(229, 229, 229)`,Wd=10,Gd=.4,Kd=.12,qd=.25;function Jd(e){return new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=n,r.src=e})}function Yd(e){let t=new Cn(e).getHex();return[t>>16&255,t>>8&255,t&255]}var Xd=Math.random()*2**32>>>0;function Zd(){return{seed:Xd,logoFraction:mu,roundness:Hu,logoStrength:Ku,fibreStrength:qu,shadowLength:_d,speckle:Ed,pulp:Dd,fibres:Od,fibreCurl:kd,fibreLengthMin:Ad,fibreLengthMax:jd,fibreAngleSpread:Md,fibreRelief:Nd,fibreColor:Vd,scratches:Pd,scratchDepth:Fd,creases:Id,creaseWidth:Ld,creaseTilt:Rd,creaseLine:zd,creaseRound:Bd,paperFrom:Yd(Hd),paperTo:Yd(Ud)}}function Qd(e,t){let n=null,r=0,i=0,a=typeof Worker<`u`&&typeof OffscreenCanvas<`u`&&typeof createImageBitmap<`u`,o=(async()=>{if(a)try{n=new Worker(new URL(new URL(`paperTextures.worker-BqskWowQ.js`,import.meta.url).href,``+import.meta.url),{type:`module`});let r=await createImageBitmap(e);n.postMessage({type:`logo`,bitmap:r},[r]),n.onmessage=e=>{e.data.id===i&&t(e.data)},n.onerror=()=>{n.terminate(),n=null}}catch{n=null}})();return{async request(a,s,c,l={}){await o;let u=i=++r,d={...Zd(),...l};n?n.postMessage({type:`generate`,id:u,w:a,h:s,px:c,settings:d}):setTimeout(()=>{u===i&&t({id:u,w:a,h:s,...Lu(e,a,s,c,d)})},0)},dispose(){n?.terminate()}}}function $d(e,t,n,r,i=!0){let a=new Kr(e,t,n,F,S);return a.minFilter=a.magFilter=y,a.generateMipmaps=!1,i&&(a.wrapS=a.wrapT=h),r&&(a.colorSpace=Ke),a.needsUpdate=!0,a.onUpdate=()=>{a.image.data=null},a}async function ef(e,t,n={}){let r=new Uc({antialias:!1,depth:!1,stencil:!1,alpha:!1,powerPreference:`high-performance`});r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.toneMapping=0,r.domElement.style.opacity=`0`,r.domElement.style.transition=`opacity 0.6s ease`,e.appendChild(r.domElement);let i=new Tn,a=new ra(-1,1,1,-1,.1,20);a.position.set(0,10,0),a.up.set(0,0,-1),a.lookAt(0,0,0);let o=Gu/Math.hypot(Gu,6);i.add(new Wi(`#ffffff`,`#ffffff`,Wu*Uu));let s=new aa(`#ffffff`,2.55/o*Uu);i.add(s);let c=await Jd(t),l=fl(),u=new xi({roughness:.92}),d={...l.uniforms,logoMap:{value:null},emboss:{value:0},pressCenter:{value:new K},pressAmount:{value:0},ghostCenter:{value:new K},ghostAmount:{value:0},pressActive:{value:0},pressRadius:{value:$u},pressEdge:{value:ed},pressInvert:{value:td},paintMap:{value:null},inkBounds:{value:null},inkSkip:{value:fd},inkBaseReach:{value:1},inkBaseGap:{value:hd},inkOnLogo:{value:gd},inkGapSide:{value:1},inkDebug:{value:0},inkGroove:{value:pd},inkBlotch:{value:dd},paintTexel:{value:new K(1,1)},inkBleed:{value:1},inkWick:{value:ld},inkPool:{value:ud},lightDir:{value:new K(1,0)},shadowLength:{value:_d},shadowStrength:{value:vd},poolOffset:{value:yd},poolRadius:{value:bd},poolBright:{value:xd},poolDark:{value:Sd},farSideDark:{value:wd},farSideReach:{value:Td},poolTint:{value:Cd},pressTrail:{value:Array.from({length:ad},()=>new q)},paperAspect:{value:1},paperRemap:{value:new It(1,1,0,0)},panU:{value:0},inkRemap:{value:new It(1,1,0,0)}};u.onBeforeCompile=e=>{Object.assign(e.uniforms,d),e.fragmentShader=e.fragmentShader.replace(`#include <normalmap_pars_fragment>`,`#include <normalmap_pars_fragment>
        ${dl}
        ...
        gl_FragColor.rgb = mix( gl_FragColor.rgb, fogColor, fogDensity( wp ) );`)};let f=new Ur(new ui(1,1),u);f.rotation.x=-Math.PI/2,f.visible=!1,i.add(f);let p=sl(i,r.getPixelRatio()),m=zl();m.uniforms.inkOpacity.value=0;let h=1;Object.assign(d,m.uniforms),d.paintMap.value=m.texture,d.inkBounds.value=m.bounds;let g=Gl(r,{blur:Wd,amount:Gd,tint:Kd});g.setMask(m.texture,d.inkRemap.value,m.uniforms.inkOpacity,qd);let _=null,v=null,y=null,b=null,x=null,S=Qd(c,({w:e,h:t,color:n,surface:r,logo:i})=>{for(let e of v??[])e.dispose();v=[$d(n,e,t,!0),$d(r,e,t,!1),$d(i,e,t,!1,!1)],v.uploaded=0,v.size=y}),C=!1,w=()=>{if(!v||C)return;if(v.uploaded<v.length){r.initTexture(v[v.uploaded++]);return}let[e,t,n]=v;b=v.size,D(),v=null;let o=!u.map;if(u.map?.dispose(),u.normalMap?.dispose(),d.logoMap.value?.dispose(),u.map=e,u.normalMap=t,d.logoMap.value=n,o){u.needsUpdate=!0,C=!0,r.setRenderTarget(g.target);let e=r.compileAsync(i,a);r.setRenderTarget(null),e.then(()=>{C=!1,f.visible=!0,_=Te,r.domElement.style.opacity=`1`})}},T=()=>[e.clientWidth,e.clientHeight],E=(e,t)=>{let[n,r]=T(),[i,a,o=0,s=0]=t??[n,r],c=i+o+s,l=Math.min(i,a)/Math.min(n,r),u=n*l/c,d=r*l/a;e.set(u,d,(o+i/2-(n/2+O.px)*l)/c,.5-.5*d)},D=()=>{E(d.paperRemap.value,b),E(d.inkRemap.value,x)},O={px:0,from:0,to:0,t:1},k=t=>{if(O.t>=1)return;O.t=Math.min(1,O.t+t/Ru);let n=O.t<.5?4*O.t**3:1-(-2*O.t+2)**3/2;O.px=O.from+(O.to-O.from)*n,d.panU.value=O.px/e.clientWidth,D()},A=()=>{let[e,t]=T(),n=e/t;r.setSize(e,t,!1),g.setSize(e,t,r.getPixelRatio()),a.left=-n,a.right=n,a.top=1,a.bottom=-1,a.updateProjectionMatrix(),f.scale.set(n*2,2,1),d.paperAspect.value=n,d.shadowLength.value=_d*Math.min(1,n),p.setAspect(n),d.panU.value=O.px/e,D();let i=180-Math.atan2(e,t)*180/Math.PI;document.documentElement.style.backgroundImage=`linear-gradient(${i}deg, ${Hd}, ${Ud})`},j=e=>({left:Math.max(0,Math.ceil(e?.left??0)),right:Math.max(0,Math.ceil(e?.right??0))}),ee=j(n.panExtent),M=()=>{let[e,t]=T(),{left:n,right:i}=ee,a=n+i,o=Math.min(1,Bu/(Math.max(e+a,t)*r.getPixelRatio())),s=Math.round((e+a)*r.getPixelRatio()*o),c=Math.round(t*r.getPixelRatio()*o),l=Math.min(1,Vu/(Math.max(e+a,t)*r.getPixelRatio())),u=Math.round((e+a)*r.getPixelRatio()*l),f=Math.round(t*r.getPixelRatio()*l),p=u/(e+a);m.resize(u,f,p,{cx:(n+e/2)*p,base:Math.min(e,t)*p}),m.setBlurReach(5.4),x=[e,t,n,i],d.paintTexel.value.set(1/u,1/f),d.inkBleed.value=cd*p,d.inkBaseReach.value=md*p,D(),y=[e,t,n,i];let h=s/(e+a);S.request(s,c,h,{logoX:(n+e/2)*h,logoBase:Math.min(e,t)*h})};A(),M();let N,P=T().join(`x`),te=new ResizeObserver(()=>{let e=T().join(`x`);e!==P&&(P=e,A(),clearTimeout(N),N=setTimeout(M,200))});te.observe(e);let F={x:0,y:0,active:!1,touch:!1},ne=e=>{let t=r.domElement.getBoundingClientRect();return[(((e.clientX-t.left)/t.width-d.panU.value)*2-1)*d.paperAspect.value,(e.clientY-t.top)/t.height*2-1]},re=e=>{let t=r.domElement.getBoundingClientRect(),n=d.inkRemap.value;return[((e.clientX-t.left)/t.width*n.x+n.z)*m.width,((e.clientY-t.top)/t.height*n.y+n.w)*m.height]},I=(e,t)=>({held:!1,pressing:!1,target:new K,lastDrop:new K,center:e.value,amount:t}),ie={user:I(d.pressCenter,d.pressAmount),ghost:I(d.ghostCenter,d.ghostAmount)},L=(e,t)=>{let n=ie[e];n.held=n.pressing=!0,n.target.set(...ne(t)),n.center.copy(n.target),n.lastDrop.copy(n.target),m.begin(...re(t),t.timeStamp,e)},ae=(e,t)=>{let n=ie[e];if(!n.held)return;n.target.set(...ne(t));let r=t.getCoalescedEvents?.()??[];for(let n of r.length?r:[t])m.move(...re(n),n.timeStamp,e)},oe=e=>{ie[e].held=!1,m.end(e)},se=eu(),ce=e=>{if(!(se.active&&e.pointerType===`touch`)){let t=r.domElement.getBoundingClientRect();F.x=(e.clientX-t.left)/t.width*2-1,F.y=(e.clientY-t.top)/t.height*2-1,F.active=!0,F.touch=e.pointerType===`touch`}ae(`user`,e)},le=()=>{F.active=!1,oe(`user`)},ue=e=>{ce(e),L(`user`,e),r.domElement.setPointerCapture?.(e.pointerId)},de=()=>oe(`user`),fe=Ql({element:r.domElement,offset:()=>O.px,clearPaper:()=>(m.clear(),fetch(`/__clear-sketches`,{method:`POST`}).then(e=>{if(!e.ok)return e.text().then(e=>Promise.reject(Error(e)))})),container:e,down:e=>L(`ghost`,e),move:e=>ae(`ghost`,e),up:()=>oe(`ghost`)}),R=pu({element:r.domElement,offset:()=>O.px,pen:{begin:(e,t,n,r,i)=>m.begin(...re({clientX:t,clientY:n}),r,e,{age:i}),move:(e,t,n,r)=>m.move(...re({clientX:t,clientY:n}),r,e),end:e=>m.end(e)},onClear:()=>m.clear()}),z=!0,pe=(e,t)=>{let n=R.listen(e,t);return fe.listen(e,t=>e===`down`&&!z?ce(t):n(t))},me=[[r.domElement,`pointermove`,pe(`move`,ce)],[r.domElement,`pointerleave`,pe(`leave`,le)],[r.domElement,`pointerdown`,pe(`down`,ue)],[window,`pointerup`,pe(`up`,de)],[window,`pointercancel`,pe(`up`,de)],[window,`keydown`,e=>{e.key.toLowerCase()===`d`&&!e.metaKey&&!e.ctrlKey&&!e.altKey&&ge(!d.inkDebug.value)}]];for(let[e,t,n]of me)e.addEventListener(t,n);let he=null,ge=t=>{if(d.inkDebug.value=+!!t,t&&!he){he=document.createElement(`div`),Object.assign(he.style,{position:`fixed`,left:`calc(12px + env(safe-area-inset-left, 0px))`,bottom:`calc(12px + env(safe-area-inset-bottom, 0px))`,zIndex:1,padding:`8px 10px`,borderRadius:`8px`,background:`rgba(255, 255, 255, 0.85)`,font:`12px/1.5 system-ui, sans-serif`,color:`#333`,pointerEvents:`none`});let t=e=>`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;margin-right:6px;vertical-align:-1px;background:${e}"></span>`;he.innerHTML=[`<b>Ink debug</b> (D to hide)`,`${t(`rgb(26,217,64)`)}Gap: pen leaving a raised line`,`${t(`rgb(38,89,255)`)}No gap: pen coming up to, or along, the line`,`${t(`conic-gradient(red, yellow, lime, cyan, blue, magenta, red)`)}Ink: tinted by drawing direction`].join(`<br>`),e.appendChild(he)}else!t&&he&&(he.remove(),he=null)};new URLSearchParams(location.search).has(`debug`)&&ge(!0);let _e=document.querySelector(`meta[name="theme-color"]`),ve=0,ye=``,be=!1,xe=()=>{!f.visible||be||Te-ve<.4||(ve=Te,be=!0,g.edgeColors().then(({top:e,bottom:t})=>{let n=e=>`rgb(${e.map(Math.round).join(`, `)})`,r=n(e)+n(t);r!==ye&&(ye=r,document.documentElement.style.backgroundColor=n(t),_e?.setAttribute(`content`,n(e)))}).catch(()=>{}).finally(()=>{be=!1}))},Se=new ua;Se.connect(document);let Ce=-Math.PI*.75,we=0,Te=0;return r.setAnimationLoop(e=>{Se.update(e);let t=Se.getDelta();Te+=t;let n=_===null?0:Te-_,o=Math.min(1,Math.max(0,(n-Ju)/Yu));d.emboss.value=(1-2**(-10*o))/(1-2**-10);let c=d.pressTrail.value,u=Math.exp(-t*sd),f=!1;for(let e of c)e.z*=u,e.z>.001&&(f=!0);for(let e of Object.values(ie)){e.pressing&&!e.held&&e.amount.value>.95&&(e.pressing=!1),e.held&&e.center.lerp(e.target,1-Math.exp(-t*id));let n=e.pressing?nd:rd;if(e.amount.value+=(+!!e.pressing-e.amount.value)*(1-Math.exp(-t*n)),e.amount.value>.001&&(f=!0),e.held&&e.center.distanceTo(e.lastDrop)>od){let t=c[0];for(let e of c)e.z<t.z&&(t=e);t.set(e.center.x,e.center.y,e.amount.value),e.lastDrop.copy(e.center)}}d.pressActive.value=+!!f;let v=Math.min(t,.1),y,b=null;F.active&&!(se.active&&F.touch)?b=Math.atan2(F.y,F.x):se.active&&Math.hypot(se.x,se.y)>Qu&&(b=Math.atan2(se.y*-1,se.x*-1)),y=b===null?Xu*(Zu-we):25*Math.atan2(Math.sin(b-Ce),Math.cos(b-Ce))-10*we,we+=y*v,Ce+=we*v,s.position.set(Math.cos(Ce)*6,Gu,Math.sin(Ce)*6),d.lightDir.value.set(Math.cos(Ce),Math.sin(Ce)),p.update(Math.min(t,.1),Te,s.position),l.update(Math.min(t,.1),n,p.wind),w(),k(Math.min(t,.25));let x=+!!z;if(h!==x){let e=Math.min(t,.25)/zu;h=x>h?Math.min(1,h+e):Math.max(0,h-e)}m.uniforms.inkOpacity.value=h*d.emboss.value;let S=n-Ju-Yu;fe.update(_!==null&&S>=0,S),R.update(),m.setTime(Te),m.update(v,performance.now()),m.flush(r),g.render(i,a),xe()}),Object.assign(Ee,{setPan(e){e!==O.to&&Object.assign(O,{from:O.px,to:e,t:0})},setDrawing(e){z=e,!e&&ie.user.held&&de()},setPanExtent(e){let t=j(e),n=(e,t)=>Math.abs(e-t)<12&&e<=t;n(t.left,ee.left)&&n(t.right,ee.right)||(ee=t,clearTimeout(N),N=setTimeout(M,200))}});function Ee(){r.setAnimationLoop(null),Se.dispose(),se.dispose(),clearTimeout(N),te.disconnect();for(let[e,t,n]of me)e.removeEventListener(t,n);he?.remove(),fe.dispose(),R.dispose(),S.dispose();for(let e of v??[])e.dispose();p.dispose(),m.dispose(),g.dispose(),u.map?.dispose(),u.normalMap?.dispose(),d.logoMap.value?.dispose(),u.dispose(),f.geometry.dispose(),r.dispose(),r.domElement.remove()}}var tf=[`aloisius`,`THE NARRATOR`,`NWAKKE`,`Isaiah Hull`,`jaso`,`inuri`,`Burden Reserve`,`Zerosome`,`orchestra379`,`(also)`],nf=`3x555lnx`,rf=`production`,af=`2025-02-19`;async function of(e,t={}){let n=new URLSearchParams({query:e});for(let[e,r]of Object.entries(t))n.set(`$${e}`,JSON.stringify(r));let r=`https://${nf}.apicdn.sanity.io/v${af}/data/query/${rf}?${n}`,i=await fetch(r);if(!i.ok)throw Error(`Sanity query failed (${i.status})`);return(await i.json()).result}var sf=()=>of(`*[_type == "artist" && defined(name)] | order(sortOrder asc, name asc) { name, "slug": slug.current }`),cf=e=>of(`*[_type == "artist" && slug.current == $slug][0] {
    ...
    }`,{slug:e}),lf=(e,t)=>e?`${e}?w=${Math.round(t*2)}&fit=max&auto=format`:void 0,uf=()=>of(`*[_type == "event" && defined(date)] | order(date asc) {
    ...
    }`),df=()=>of(`*[_id == "info"][0].text`),ff=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=e(((e,t)=>{t.exports=ff()}))(),pf=e=>e?new Date(`${e}T00:00:00Z`).toLocaleDateString(`en-US`,{month:`long`,day:`numeric`,year:`numeric`,timeZone:`UTC`}).toUpperCase():null;function mf({value:e}){return e?.length?e.map(e=>e._type===`block`?(0,$.jsx)(`p`,{children:e.children?.map(t=>{let n=t.text;for(let r of t.marks??[])if(r===`strong`)n=(0,$.jsx)(`strong`,{children:n});else if(r===`em`)n=(0,$.jsx)(`em`,{children:n});else{let t=e.markDefs?.find(e=>e._key===r);t?.href&&(n=(0,$.jsx)(`a`,{href:t.href,target:`_blank`,rel:`noreferrer`,children:n}))}return(0,$.jsx)(`span`,{children:n},t._key)})},e._key):null):null}function hf(e){let t=(0,f.c)(2),{href:n}=e;if(!n)return null;let r;return t[0]===n?r=t[1]:(r=(0,$.jsx)(`a`,{className:`ap-listen`,href:n,target:`_blank`,rel:`noreferrer`,children:`Listen`}),t[0]=n,t[1]=r),r}function gf(e){let t=(0,f.c)(20),{item:n,kind:r}=e,i;t[0]===n.title?i=t[1]:(i=(0,$.jsx)(`h3`,{children:n.title}),t[0]=n.title,t[1]=i);let a;t[2]===n.link?a=t[3]:(a=(0,$.jsx)(hf,{href:n.link}),t[2]=n.link,t[3]=a);let o;t[4]!==i||t[5]!==a?(o=(0,$.jsxs)(`div`,{className:`ap-release-head`,children:[i,a]}),t[4]=i,t[5]=a,t[6]=o):o=t[6];let s;t[7]===n.date?s=t[8]:(s=pf(n.date),t[7]=n.date,t[8]=s);let c;t[9]!==r||t[10]!==s?(c=[s,r].filter(Boolean),t[9]=r,t[10]=s,t[11]=c):c=t[11];let l=c.join(` • `),u;t[12]===l?u=t[13]:(u=(0,$.jsx)(`p`,{className:`ap-meta`,children:l}),t[12]=l,t[13]=u);let d;t[14]===n.description?d=t[15]:(d=(0,$.jsx)(`div`,{className:`ap-rich`,children:(0,$.jsx)(mf,{value:n.description})}),t[14]=n.description,t[15]=d);let p;return t[16]!==o||t[17]!==u||t[18]!==d?(p=(0,$.jsxs)(`div`,{className:`ap-release-text`,children:[o,u,d]}),t[16]=o,t[17]=u,t[18]=d,t[19]=p):p=t[19],p}function _f(e){let t=(0,f.c)(19),{item:n,artistName:r}=e,i;t[0]===n.tracklist?i=t[1]:(i=n.tracklist??[],t[0]=n.tracklist,t[1]=i);let a=i,o=n.artwork?.url,s;t[2]===o?s=t[3]:(s=lf(o,240),t[2]=o,t[3]=s);let c=n.artwork?.alt??n.title,l;t[4]!==s||t[5]!==c?(l=(0,$.jsx)(`img`,{className:`ap-art`,src:s,alt:c}),t[4]=s,t[5]=c,t[6]=l):l=t[6];let u=a.length?`${a.length} track album`:`album`,d;t[7]!==n||t[8]!==u?(d=(0,$.jsx)(gf,{item:n,kind:u}),t[7]=n,t[8]=u,t[9]=d):d=t[9];let p;t[10]!==r||t[11]!==a?(p=a.length>0&&(0,$.jsx)(`ol`,{className:`ap-tracks`,children:a.map((e,t)=>(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`span`,{className:`ap-track-no`,children:(0,$.jsx)(`span`,{className:`ap-track-dot`,children:t+1})}),(0,$.jsx)(`strong`,{children:e.title}),` `,e.credit||r]},e._key))}),t[10]=r,t[11]=a,t[12]=p):p=t[12];let m;t[13]!==d||t[14]!==p?(m=(0,$.jsxs)(`div`,{children:[d,p]}),t[13]=d,t[14]=p,t[15]=m):m=t[15];let h;return t[16]!==l||t[17]!==m?(h=(0,$.jsxs)(`article`,{className:`ap-release ap-album`,children:[l,m]}),t[16]=l,t[17]=m,t[18]=h):h=t[18],h}function vf(e){let t=(0,f.c)(10),{item:n}=e,r=n.artwork?.url,i;t[0]===r?i=t[1]:(i=lf(r,170),t[0]=r,t[1]=i);let a=n.artwork?.alt??n.title,o;t[2]!==i||t[3]!==a?(o=(0,$.jsx)(`img`,{className:`ap-art`,src:i,alt:a}),t[2]=i,t[3]=a,t[4]=o):o=t[4];let s;t[5]===n?s=t[6]:(s=(0,$.jsx)(gf,{item:n,kind:`single`}),t[5]=n,t[6]=s);let c;return t[7]!==o||t[8]!==s?(c=(0,$.jsxs)(`article`,{className:`ap-release ap-single`,children:[o,s]}),t[7]=o,t[8]=s,t[9]=c):c=t[9],c}function yf(e){let t=(0,f.c)(12),{m:n,width:r}=e;if(n._type===`video`){let e=n.url,i;t[0]!==n.poster||t[1]!==r?(i=lf(n.poster,r),t[0]=n.poster,t[1]=r,t[2]=i):i=t[2];let a;return t[3]!==n.url||t[4]!==i?(a=(0,$.jsx)(`video`,{src:e,poster:i,controls:!0,muted:!0,playsInline:!0,loop:!0,preload:`metadata`}),t[3]=n.url,t[4]=i,t[5]=a):a=t[5],a}let i;t[6]!==n.url||t[7]!==r?(i=lf(n.url,r),t[6]=n.url,t[7]=r,t[8]=i):i=t[8];let a=n.alt??``,o;return t[9]!==i||t[10]!==a?(o=(0,$.jsx)(`img`,{src:i,alt:a}),t[9]=i,t[10]=a,t[11]=o):o=t[11],o}function bf(e){let t=(0,f.c)(9),{item:n}=e,r,i,a;if(t[0]!==n.alignment||t[1]!==n.items||t[2]!==n.layout){a=Symbol.for(`react.early_return_sentinel`);bb0:{let e=n.items??[];if(n.layout===`double`){a=(0,$.jsx)(`div`,{className:`ap-media ap-media-double`,children:e.slice(0,2).map(Sf)});break bb0}r=`ap-media ap-media-single ap-align-${n.alignment??`center`}`,i=e.slice(0,1).map(xf)}t[0]=n.alignment,t[1]=n.items,t[2]=n.layout,t[3]=r,t[4]=i,t[5]=a}else r=t[3],i=t[4],a=t[5];if(a!==Symbol.for(`react.early_return_sentinel`))return a;let o;return t[6]!==r||t[7]!==i?(o=(0,$.jsx)(`div`,{className:r,children:i}),t[6]=r,t[7]=i,t[8]=o):o=t[8],o}function xf(e){return(0,$.jsx)(yf,{m:e,width:340},e._key)}function Sf(e){return(0,$.jsx)(yf,{m:e,width:340},e._key)}var Cf=()=>{let e=(0,f.c)(1),t;return e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t=(0,$.jsxs)(`svg`,{viewBox:`0 0 64 28`,width:`58`,height:`26`,"aria-hidden":`true`,children:[(0,$.jsx)(`path`,{d:`M10 5h16L18 23H2z`,fill:`currentColor`}),(0,$.jsx)(`text`,{x:`30`,y:`21`,fontFamily:`Helvetica Neue, Helvetica, Arial, sans-serif`,fontSize:`19`,fontWeight:`500`,fill:`currentColor`,children:`bc`})]}),e[0]=t):t=e[0],t},wf=()=>{let e=(0,f.c)(1),t;return e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t=(0,$.jsxs)(`svg`,{viewBox:`0 0 28 28`,width:`30`,height:`30`,"aria-hidden":`true`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.2`,children:[(0,$.jsx)(`rect`,{x:`2`,y:`2`,width:`24`,height:`24`,rx:`7`}),(0,$.jsx)(`circle`,{cx:`14`,cy:`14`,r:`5.5`}),(0,$.jsx)(`circle`,{cx:`21`,cy:`7`,r:`1.1`,fill:`currentColor`,stroke:`none`})]}),e[0]=t):t=e[0],t};function Tf(e){let t=(0,f.c)(20),{slug:n,onClose:r}=e,[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)(!1),c,u;t[0]===n?(c=t[1],u=t[2]):(c=()=>{if(!n)return;let e=!1;return cf(n).then(t=>{e||(a(t),s(!t))}).catch(()=>!e&&s(!0)),()=>{e=!0}},u=[n],t[0]=n,t[1]=c,t[2]=u),(0,l.useEffect)(c,u);let d=!!n,p=d&&i?.slug===n?i:null,m=`artist-page${d?` open`:``}${p?` loaded`:``}`,h=!d,g;t[3]===r?g=t[4]:(g=e=>{let t=e.target.classList;(e.target===e.currentTarget||t.contains(`ap-scroll`)||t.contains(`ap-inner`))&&r()},t[3]=r,t[4]=g);let _;t[5]!==o||t[6]!==d||t[7]!==p?(_=d&&o&&!p&&(0,$.jsx)(`p`,{className:`ap-missing`,children:`This artist couldn't be loaded.`}),t[5]=o,t[6]=d,t[7]=p,t[8]=_):_=t[8];let v;t[9]!==i||t[10]!==r?(v=i&&(0,$.jsxs)(`div`,{className:`ap-inner`,children:[(0,$.jsxs)(`aside`,{className:`ap-profile`,children:[i.artwork?.url&&(0,$.jsx)(`img`,{className:`ap-portrait`,src:lf(i.artwork.url,520),alt:i.artwork.alt??i.name}),(0,$.jsxs)(`a`,{className:`ap-back`,href:`#artists`,onClick:e=>{e.preventDefault(),r()},children:[(0,$.jsx)(`span`,{"aria-hidden":`true`,children:`←`}),` `,i.name]}),(0,$.jsx)(`div`,{className:`ap-rich ap-bio`,children:(0,$.jsx)(mf,{value:i.description})}),(0,$.jsxs)(`div`,{className:`ap-links`,children:[i.bandcamp&&(0,$.jsx)(`a`,{href:i.bandcamp,target:`_blank`,rel:`noreferrer`,"aria-label":`Bandcamp`,children:(0,$.jsx)(Cf,{})}),i.instagram&&(0,$.jsx)(`a`,{href:i.instagram,target:`_blank`,rel:`noreferrer`,"aria-label":`Instagram`,children:(0,$.jsx)(wf,{})})]})]}),(0,$.jsx)(`section`,{className:`ap-content`,children:(i.content??[]).map(e=>e._type===`album`?(0,$.jsx)(_f,{item:e,artistName:i.name},e._key):e._type===`single`?(0,$.jsx)(vf,{item:e},e._key):e._type===`media`?(0,$.jsx)(bf,{item:e},e._key):null)})]}),t[9]=i,t[10]=r,t[11]=v):v=t[11];let y;t[12]===v?y=t[13]:(y=(0,$.jsx)(`div`,{className:`ap-scroll`,children:v}),t[12]=v,t[13]=y);let b;return t[14]!==m||t[15]!==h||t[16]!==g||t[17]!==_||t[18]!==y?(b=(0,$.jsxs)(`div`,{className:m,"aria-hidden":h,onClick:g,children:[_,y]}),t[14]=m,t[15]=h,t[16]=g,t[17]=_,t[18]=y,t[19]=b):b=t[19],b}var Ef=[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`],Df=[`JANUARY`,`FEBRUARY`,`MARCH`,`APRIL`,`MAY`,`JUNE`,`JULY`,`AUGUST`,`SEPTEMBER`,`OCTOBER`,`NOVEMBER`,`DECEMBER`],Of=(e,t,n)=>`${e}-${String(t+1).padStart(2,`0`)}-${String(n).padStart(2,`0`)}`,kf=()=>{let e=new Date;return Of(e.getFullYear(),e.getMonth(),e.getDate())},Af=e=>new Date(`${e}T00:00:00Z`).toLocaleDateString(`en-GB`,{weekday:`short`,day:`numeric`,month:`short`,year:`numeric`,timeZone:`UTC`}).replace(/,/g,``).replace(/^(\w+) /,`$1, `).toUpperCase();function jf(e){let t=(0,f.c)(12),{lineup:n,onArtist:r}=e,i,a,o,s,c;if(t[0]!==n||t[1]!==r){c=Symbol.for(`react.early_return_sentinel`);bb0:{let e=(n??[]).filter(Mf);if(!e.length){c=null;break bb0}i=`hp-lineup`,a=`alongside`,o=` `,s=e.map((t,n)=>{let i=t.artist?.name??t.name,a=n<e.length-1?`, `:``;return t.artist?.slug?(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`a`,{href:`#artists/${encodeURIComponent(t.artist.slug)}`,onClick:e=>{e.preventDefault(),r(t.artist.slug)},children:i}),a]},t._key):t.url?(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`a`,{href:t.url,target:`_blank`,rel:`noreferrer`,children:i}),a]},t._key):(0,$.jsxs)(`span`,{children:[i,a]},t._key)})}t[0]=n,t[1]=r,t[2]=i,t[3]=a,t[4]=o,t[5]=s,t[6]=c}else i=t[2],a=t[3],o=t[4],s=t[5],c=t[6];if(c!==Symbol.for(`react.early_return_sentinel`))return c;let l;return t[7]!==i||t[8]!==a||t[9]!==o||t[10]!==s?(l=(0,$.jsxs)(`p`,{className:i,children:[a,o,s]}),t[7]=i,t[8]=a,t[9]=o,t[10]=s,t[11]=l):l=t[11],l}function Mf(e){return e.artist?.name||e.name}function Nf(e){let t=(0,f.c)(28),{event:n,onArtist:r}=e,i=n._id,a;t[0]!==n.poster||t[1]!==n.title?(a=n.poster?.url&&(0,$.jsx)(`img`,{className:`hp-poster`,src:lf(n.poster.url,400),alt:n.poster.alt??n.title}),t[0]=n.poster,t[1]=n.title,t[2]=a):a=t[2];let o;t[3]===n.title?o=t[4]:(o=(0,$.jsx)(`h2`,{children:n.title}),t[3]=n.title,t[4]=o);let s;t[5]===n.date?s=t[6]:(s=Af(n.date),t[5]=n.date,t[6]=s);let c;t[7]!==n.time||t[8]!==n.venue||t[9]!==s?(c=[s,n.time,n.venue].filter(Boolean),t[7]=n.time,t[8]=n.venue,t[9]=s,t[10]=c):c=t[10];let l=c.join(` • `),u;t[11]===l?u=t[12]:(u=(0,$.jsx)(`p`,{className:`ap-meta`,children:l}),t[11]=l,t[12]=u);let d;t[13]!==n.lineup||t[14]!==r?(d=(0,$.jsx)(jf,{lineup:n.lineup,onArtist:r}),t[13]=n.lineup,t[14]=r,t[15]=d):d=t[15];let p;t[16]===n.description?p=t[17]:(p=(0,$.jsx)(`div`,{className:`ap-rich hp-description`,children:(0,$.jsx)(mf,{value:n.description})}),t[16]=n.description,t[17]=p);let m;t[18]===n.ticketUrl?m=t[19]:(m=n.ticketUrl&&(0,$.jsx)(`a`,{className:`ap-listen hp-tickets`,href:n.ticketUrl,target:`_blank`,rel:`noreferrer`,children:`get tickets`}),t[18]=n.ticketUrl,t[19]=m);let h;return t[20]!==n._id||t[21]!==m||t[22]!==a||t[23]!==o||t[24]!==u||t[25]!==d||t[26]!==p?(h=(0,$.jsxs)(`div`,{className:`hp-details`,children:[a,o,u,d,p,m]},i),t[20]=n._id,t[21]=m,t[22]=a,t[23]=o,t[24]=u,t[25]=d,t[26]=p,t[27]=h):h=t[27],h}function Pf(e){let t=(0,f.c)(67),{open:n,onClose:r,onArtist:i}=e,[a,o]=(0,l.useState)(null),[s,c]=(0,l.useState)(Lf),[u,d]=(0,l.useState)(null),p,m;t[0]!==a||t[1]!==n?(p=()=>{if(!n||a)return;let e=!1;return uf().then(t=>!e&&o(t??[])).catch(()=>!e&&o([])),()=>{e=!0}},m=[n,a],t[0]=a,t[1]=n,t[2]=p,t[3]=m):(p=t[2],m=t[3]),(0,l.useEffect)(p,m);let h=kf(),g;if(t[4]!==a){g=new Map;for(let e of a??[])g.set(e.date,[...g.get(e.date)??[],e]);t[4]=a,t[5]=g}else g=t[5];let _=g,v;t[6]!==u||t[7]!==a?(v=(a??[]).find(e=>e._id===u)??(a??[]).find(e=>e.date>=h)??(a??[]).at(-1)??null,t[6]=u,t[7]=a,t[8]=v):v=t[8];let y=v,{y:b,m:x}=s,S;t[9]!==x||t[10]!==b?(S=new Date(b,x,1).getDay(),t[9]=x,t[10]=b,t[11]=S):S=t[11];let C=(S+6)%7,w,T,E,D,O,k,A,j,ee,M;if(t[12]!==_||t[13]!==y||t[14]!==a||t[15]!==C||t[16]!==x||t[17]!==r||t[18]!==n||t[19]!==b){let e=new Date(b,x+1,0).getDate(),i=[...Array(C).fill(null),...Array.from({length:e},If)],o;t[30]===Symbol.for(`react.memo_cache_sentinel`)?(o=e=>c(t=>{let{y:n,m:r}=t;return{y:n+Math.floor((r+e)/12),m:(r+e+12)%12}}),t[30]=o):o=t[30];let s=o;E=`artist-page happenings-page${n?` open`:``}${a?` loaded`:``}`,D=!n,t[31]===r?O=t[32]:(O=e=>{let t=e.target.classList;(e.target===e.currentTarget||t.contains(`ap-scroll`)||t.contains(`hp-inner`))&&r()},t[31]=r,t[32]=O),T=`ap-scroll`,w=`ap-inner hp-inner`,ee=`hp-calendar`;let l;t[33]===Symbol.for(`react.memo_cache_sentinel`)?(l=(0,$.jsx)(`button`,{type:`button`,onClick:()=>s(-1),"aria-label":`Previous month`,children:`←`}),t[33]=l):l=t[33];let u=Df[x],f;t[34]!==u||t[35]!==b?(f=(0,$.jsxs)(`h2`,{children:[u,` `,b]}),t[34]=u,t[35]=b,t[36]=f):f=t[36];let p;t[37]===Symbol.for(`react.memo_cache_sentinel`)?(p=(0,$.jsx)(`button`,{type:`button`,onClick:()=>s(1),"aria-label":`Next month`,children:`→`}),t[37]=p):p=t[37],t[38]===f?M=t[39]:(M=(0,$.jsxs)(`div`,{className:`hp-month`,children:[l,f,p]}),t[38]=f,t[39]=M),k=`hp-grid`,t[40]===Symbol.for(`react.memo_cache_sentinel`)?(A=Ef.map(Ff),t[40]=A):A=t[40],j=i.map((e,t)=>{if(!e)return(0,$.jsx)(`div`,{},`blank${t}`);let n=Of(b,x,e),r=_.get(n)??[],i=r[0],a=n<h,o=i&&y&&r.some(e=>e._id===y._id);return(0,$.jsxs)(`button`,{type:`button`,className:`hp-day${a?` past`:``}${i?` has-event`:``}${o?` chosen`:``}`,disabled:!i,onClick:()=>{if(!i)return;let e=r.findIndex(e=>e._id===y?._id);d(r[(e+1)%r.length]._id)},"aria-label":i?`${i.title}, ${Af(n)}`:void 0,children:[i?.poster?.url?(0,$.jsx)(`img`,{src:lf(i.poster.url,120),alt:``,loading:`lazy`}):(0,$.jsx)(`span`,{className:`hp-daynum`,children:e}),r.length>1&&(0,$.jsxs)(`span`,{className:`hp-more`,children:[`+`,r.length-1]})]},n)}),t[12]=_,t[13]=y,t[14]=a,t[15]=C,t[16]=x,t[17]=r,t[18]=n,t[19]=b,t[20]=w,t[21]=T,t[22]=E,t[23]=D,t[24]=O,t[25]=k,t[26]=A,t[27]=j,t[28]=ee,t[29]=M}else w=t[20],T=t[21],E=t[22],D=t[23],O=t[24],k=t[25],A=t[26],j=t[27],ee=t[28],M=t[29];let N;t[41]!==k||t[42]!==A||t[43]!==j?(N=(0,$.jsxs)(`div`,{className:k,children:[A,j]}),t[41]=k,t[42]=A,t[43]=j,t[44]=N):N=t[44];let P;t[45]!==N||t[46]!==ee||t[47]!==M?(P=(0,$.jsxs)(`section`,{className:ee,children:[M,N]}),t[45]=N,t[46]=ee,t[47]=M,t[48]=P):P=t[48];let te;t[49]!==y||t[50]!==a||t[51]!==i?(te=y?(0,$.jsx)(Nf,{event:y,onArtist:i}):a&&(0,$.jsx)(`p`,{className:`hp-empty`,children:`No happenings yet.`}),t[49]=y,t[50]=a,t[51]=i,t[52]=te):te=t[52];let F;t[53]===te?F=t[54]:(F=(0,$.jsx)(`aside`,{className:`hp-side`,children:te}),t[53]=te,t[54]=F);let ne;t[55]!==w||t[56]!==P||t[57]!==F?(ne=(0,$.jsxs)(`div`,{className:w,children:[P,F]}),t[55]=w,t[56]=P,t[57]=F,t[58]=ne):ne=t[58];let re;t[59]!==T||t[60]!==ne?(re=(0,$.jsx)(`div`,{className:T,children:ne}),t[59]=T,t[60]=ne,t[61]=re):re=t[61];let I;return t[62]!==E||t[63]!==D||t[64]!==O||t[65]!==re?(I=(0,$.jsx)(`div`,{className:E,"aria-hidden":D,onClick:O,children:re}),t[62]=E,t[63]=D,t[64]=O,t[65]=re,t[66]=I):I=t[66],I}function Ff(e){return(0,$.jsxs)(`div`,{className:`hp-dayname`,children:[(0,$.jsx)(`span`,{className:`hp-long`,children:e}),(0,$.jsx)(`span`,{className:`hp-short`,children:e.slice(0,3)})]},e)}function If(e,t){return t+1}function Lf(){let e=new Date;return{y:e.getFullYear(),m:e.getMonth()}}var Rf=new URL(`logo-oBpSohjL.jpg`,import.meta.url).href,zf=new URL(`header-logo-BgsQMK17.png`,import.meta.url).href,Bf=[`artists`,`gallery`,`happenings`,`info`],Vf=()=>{let e=window.location.hash;return e.startsWith(`#artists`)?`artists`:e===`#happenings`?`happenings`:e===`#info`?`info`:`home`},Hf=[{_type:`block`,_key:`info`,markDefs:[],children:[{_key:`t`,marks:[],text:`life is beautiful is a gesamtkunstwerk founded in early 2023 by artist & curator aloisius. the project includes an independent record label, a series of happenings and a multidisciplinary septet collective, including: THE NARRATOR, Bianca Scout, Isaiah Hull, abi asisa, NWAKKE, Jasper Maurice & aloisius.`}]}],Uf=()=>{let e=window.location.hash.match(/^#artists\/(.+)$/);return e?decodeURIComponent(e[1]):null};function Wf(){let e=(0,f.c)(60),t=(0,l.useRef)(null),n=(0,l.useRef)(null),r=(0,l.useRef)(null),[i,a]=(0,l.useState)(Vf),[o,s]=(0,l.useState)(Uf),[c,u]=(0,l.useState)(Zf),d;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(d={pan:0,right:0,top:0,infoPan:0,infoLeft:0,infoWidth:400},e[0]=d):d=e[0];let[p,m]=(0,l.useState)(d),[h,g]=(0,l.useState)(Hf),_=i===`artists`?p.pan:i===`info`?p.infoPan:0,v=(0,l.useRef)(_),y;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(y={left:0,right:0},e[1]=y):y=e[1];let b=(0,l.useRef)(y),x,S;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(x=()=>{let e,n=!1;return ef(t.current,Rf,{panExtent:b.current}).then(t=>{if(n)return t();e=t,r.current=t,t.setPan(v.current),t.setDrawing(Vf()===`home`)}),()=>{n=!0,r.current=null,e?.()}},S=[],e[2]=x,e[3]=S):(x=e[2],S=e[3]),(0,l.useEffect)(x,S);let C,w;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(C=()=>{let e=!1;return df().then(t=>!e&&t?.length&&g(t)).catch(Xf),()=>{e=!0}},w=[],e[4]=C,e[5]=w):(C=e[4],w=e[5]),(0,l.useEffect)(C,w);let T,E;e[6]===Symbol.for(`react.memo_cache_sentinel`)?(T=()=>{let e=!1;return sf().then(t=>{!e&&t?.length&&u(t)}).catch(Yf),()=>{e=!0}},E=[],e[6]=T,e[7]=E):(T=e[6],E=e[7]),(0,l.useEffect)(T,E);let D,O;e[8]===Symbol.for(`react.memo_cache_sentinel`)?(D=()=>{let e=()=>{a(Vf()),s(Uf())},t=Jf;return window.addEventListener(`hashchange`,e),window.addEventListener(`keydown`,t),()=>{window.removeEventListener(`hashchange`,e),window.removeEventListener(`keydown`,t)}},O=[],e[8]=D,e[9]=O):(D=e[8],O=e[9]),(0,l.useEffect)(D,O);let k;e[10]===Symbol.for(`react.memo_cache_sentinel`)?(k=()=>{let e=()=>{let e=t.current.getBoundingClientRect(),{pan:i,listRight:a}=hu(e.width,e.height,n.current.offsetWidth),o=_u(e.width),{pan:s,textLeft:c}=gu(e.width,e.height,o);b.current={left:i,right:-s},r.current?.setPanExtent(b.current),m({pan:i,right:window.innerWidth-(e.left+a),top:e.top+e.height/2,infoPan:s,infoLeft:e.left+c,infoWidth:o})};return e(),window.addEventListener(`resize`,e),window.addEventListener(`scroll`,e,{passive:!0}),()=>{window.removeEventListener(`resize`,e),window.removeEventListener(`scroll`,e)}},e[10]=k):k=e[10];let A;e[11]===c?A=e[12]:(A=[c],e[11]=c,e[12]=A),(0,l.useLayoutEffect)(k,A);let j,ee;e[13]===_?(j=e[14],ee=e[15]):(j=()=>{v.current=_,r.current?.setPan(_)},ee=[_],e[13]=_,e[14]=j,e[15]=ee),(0,l.useEffect)(j,ee);let M,N;e[16]===i?(M=e[17],N=e[18]):(M=()=>{r.current?.setDrawing(i===`home`)},N=[i],e[16]=i,e[17]=M,e[18]=N),(0,l.useEffect)(M,N);let P;e[19]===Symbol.for(`react.memo_cache_sentinel`)?(P=(0,$.jsx)(`div`,{ref:t,className:`scene`}),e[19]=P):P=e[19];let te;e[20]===Symbol.for(`react.memo_cache_sentinel`)?(te=(0,$.jsx)(`a`,{className:`site-logo`,href:`#`,"aria-label":`Home`,children:(0,$.jsx)(`img`,{src:zf,alt:``})}),e[20]=te):te=e[20];let F;e[21]!==o||e[22]!==i?(F=Bf.map(e=>(0,$.jsx)(`a`,{href:`#${e}`,className:i===e?`active`:void 0,onClick:t=>{i===e&&!o&&(t.preventDefault(),window.location.hash=``)},children:e},e)),e[21]=o,e[22]=i,e[23]=F):F=e[23];let ne;e[24]===F?ne=e[25]:(ne=(0,$.jsxs)(`header`,{className:`site-header`,children:[te,(0,$.jsx)(`nav`,{children:F})]}),e[24]=F,e[25]=ne);let re=`artists${i===`artists`?` open`:``}`,I;e[26]!==p.right||e[27]!==p.top?(I={right:p.right,top:p.top},e[26]=p.right,e[27]=p.top,e[28]=I):I=e[28];let ie=i!==`artists`,L;if(e[29]!==c||e[30]!==i){let t;e[32]===i?t=e[33]:(t=(e,t)=>{let{name:n,slug:r}=e;return(0,$.jsx)(`li`,{style:{"--i":t},children:(0,$.jsx)(`a`,{href:`#artists/${encodeURIComponent(r??n)}`,tabIndex:i===`artists`?0:-1,children:n})},r??n)},e[32]=i,e[33]=t),L=c.map(t),e[29]=c,e[30]=i,e[31]=L}else L=e[31];let ae;e[34]!==re||e[35]!==I||e[36]!==ie||e[37]!==L?(ae=(0,$.jsx)(`ul`,{ref:n,className:re,style:I,"aria-hidden":ie,children:L}),e[34]=re,e[35]=I,e[36]=ie,e[37]=L,e[38]=ae):ae=e[38];let oe=`info-text${i===`info`?` open`:``}`,se;e[39]!==p.infoLeft||e[40]!==p.infoWidth||e[41]!==p.top?(se={left:p.infoLeft,top:p.top,width:p.infoWidth},e[39]=p.infoLeft,e[40]=p.infoWidth,e[41]=p.top,e[42]=se):se=e[42];let ce=i!==`info`,le;e[43]===h?le=e[44]:(le=(0,$.jsx)(mf,{value:h}),e[43]=h,e[44]=le);let ue;e[45]!==oe||e[46]!==se||e[47]!==ce||e[48]!==le?(ue=(0,$.jsx)(`div`,{className:oe,style:se,"aria-hidden":ce,children:le}),e[45]=oe,e[46]=se,e[47]=ce,e[48]=le,e[49]=ue):ue=e[49];let de;e[50]===o?de=e[51]:(de=(0,$.jsx)(Tf,{slug:o,onClose:qf}),e[50]=o,e[51]=de);let fe=i===`happenings`,R;e[52]===fe?R=e[53]:(R=(0,$.jsx)(Pf,{open:fe,onClose:Kf,onArtist:Gf}),e[52]=fe,e[53]=R);let z;return e[54]!==ne||e[55]!==ae||e[56]!==ue||e[57]!==de||e[58]!==R?(z=(0,$.jsxs)($.Fragment,{children:[P,ne,ae,ue,de,R]}),e[54]=ne,e[55]=ae,e[56]=ue,e[57]=de,e[58]=R,e[59]=z):z=e[59],z}function Gf(e){return window.location.hash=`artists/${encodeURIComponent(e)}`}function Kf(){return window.location.hash=``}function qf(){return window.location.hash=`artists`}function Jf(e){e.key===`Escape`&&(Uf()?window.location.hash=`artists`:Vf()!==`home`&&(window.location.hash=``))}function Yf(e){return console.warn(`Could not load the artists from Sanity:`,e)}function Xf(){}function Zf(){return tf.map(Qf)}function Qf(e){return{name:e,slug:e}}var $f=70;function ep(){if(matchMedia(`(display-mode: standalone)`).matches||navigator.standalone||!matchMedia(`(pointer: coarse)`).matches)return()=>{};`scrollRestoration`in history&&(history.scrollRestoration=`manual`);let e=document.documentElement,t={portrait:0,landscape:0},n=0,r=()=>{let r=innerHeight>=innerWidth,i=r?Math.max(screen.width,screen.height):Math.min(screen.width,screen.height),a=r?`portrait`:`landscape`;t[a]=Math.max(t[a],Math.round(Math.min($f,Math.max(0,i-innerHeight)))),t[a]!==n&&(n=t[a],e.style.setProperty(`--overhang`,`${n}px`))},i=!1,a=()=>{i||(i=!0,requestAnimationFrame(()=>{i=!1,Math.abs(scrollY-n)>.5&&scrollTo(0,n)}))},o=()=>{r(),a()};o();let s=[`resize`,`pageshow`,`load`,`scroll`,`orientationchange`];for(let e of s)addEventListener(e,o,{passive:!0});document.addEventListener(`visibilitychange`,o);let c=[100,400,1e3,2500].map(e=>setTimeout(o,e));return()=>{for(let e of s)removeEventListener(e,o);document.removeEventListener(`visibilitychange`,o),c.forEach(clearTimeout)}}ep(),(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(Wf,{})}));